var Ci=Object.defineProperty;var Mi=(r,t,e)=>t in r?Ci(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e;var Ie=(r,t,e)=>Mi(r,typeof t!="symbol"?t+"":t,e);var Dt=typeof window<"u"&&window.customElements!=null&&window.customElements.polyfillWrapFlushCallback!==void 0,Ht=(r,t,e=null,i=null)=>{for(;t!==e;){let s=t.nextSibling;r.insertBefore(t,i),t=s}},F=(r,t,e=null)=>{for(;t!==e;){let i=t.nextSibling;r.removeChild(t),t=i}};var A=`{{lit-${String(Math.random()).slice(2)}}}`,Ut=`<!--${A}-->`,Re=new RegExp(`${A}|${Ut}`),K="$lit$",D=class{constructor(t,e){this.parts=[],this.element=e;let i=[],s=[],o=document.createTreeWalker(e.content,133,null,!1),a=0,n=-1,c=0,{strings:d,values:{length:u}}=t;for(;c<u;){let p=o.nextNode();if(p===null){o.currentNode=s.pop();continue}if(n++,p.nodeType===1){if(p.hasAttributes()){let h=p.attributes,{length:g}=h,m=0;for(let f=0;f<g;f++)Oe(h[f].name,K)&&m++;for(;m-- >0;){let f=d[c],b=gt.exec(f)[2],_=b.toLowerCase()+K,w=p.getAttribute(_);p.removeAttribute(_);let $=w.split(Re);this.parts.push({type:"attribute",index:n,name:b,strings:$}),c+=$.length-1}}p.tagName==="TEMPLATE"&&(s.push(p),o.currentNode=p.content)}else if(p.nodeType===3){let h=p.data;if(h.indexOf(A)>=0){let g=p.parentNode,m=h.split(Re),f=m.length-1;for(let b=0;b<f;b++){let _,w=m[b];if(w==="")_=P();else{let $=gt.exec(w);$!==null&&Oe($[2],K)&&(w=w.slice(0,$.index)+$[1]+$[2].slice(0,-K.length)+$[3]),_=document.createTextNode(w)}g.insertBefore(_,p),this.parts.push({type:"node",index:++n})}m[f]===""?(g.insertBefore(P(),p),i.push(p)):p.data=m[f],c+=f}}else if(p.nodeType===8)if(p.data===A){let h=p.parentNode;(p.previousSibling===null||n===a)&&(n++,h.insertBefore(P(),p)),a=n,this.parts.push({type:"node",index:n}),p.nextSibling===null?p.data="":(i.push(p),n--),c++}else{let h=-1;for(;(h=p.data.indexOf(A,h+1))!==-1;)this.parts.push({type:"node",index:-1}),c++}}for(let p of i)p.parentNode.removeChild(p)}},Oe=(r,t)=>{let e=r.length-t.length;return e>=0&&r.slice(e)===t},it=r=>r.index!==-1,P=()=>document.createComment(""),gt=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;var qt=133;function Yt(r,t){let{element:{content:e},parts:i}=r,s=document.createTreeWalker(e,qt,null,!1),o=st(i),a=i[o],n=-1,c=0,d=[],u=null;for(;s.nextNode();){n++;let p=s.currentNode;for(p.previousSibling===u&&(u=null),t.has(p)&&(d.push(p),u===null&&(u=p)),u!==null&&c++;a!==void 0&&a.index===n;)a.index=u!==null?-1:a.index-c,o=st(i,o),a=i[o]}d.forEach(p=>p.parentNode.removeChild(p))}var Ti=r=>{let t=r.nodeType===11?0:1,e=document.createTreeWalker(r,qt,null,!1);for(;e.nextNode();)t++;return t},st=(r,t=-1)=>{for(let e=t+1;e<r.length;e++){let i=r[e];if(it(i))return e}return-1};function je(r,t,e=null){let{element:{content:i},parts:s}=r;if(e==null){i.appendChild(t);return}let o=document.createTreeWalker(i,qt,null,!1),a=st(s),n=0,c=-1;for(;o.nextNode();)for(c++,o.currentNode===e&&(n=Ti(t),e.parentNode.insertBefore(t,e));a!==-1&&s[a].index===c;){if(n>0){for(;a!==-1;)s[a].index+=n,a=st(s,a);return}a=st(s,a)}}var Be=new WeakMap,Wt=r=>((...t)=>{let e=r(...t);return Be.set(e,!0),e}),H=r=>typeof r=="function"&&Be.has(r);var C={},mt={};var O=class{constructor(t,e,i){this.__parts=[],this.template=t,this.processor=e,this.options=i}update(t){let e=0;for(let i of this.__parts)i!==void 0&&i.setValue(t[e]),e++;for(let i of this.__parts)i!==void 0&&i.commit()}_clone(){let t=Dt?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),e=[],i=this.template.parts,s=document.createTreeWalker(t,133,null,!1),o=0,a=0,n,c=s.nextNode();for(;o<i.length;){if(n=i[o],!it(n)){this.__parts.push(void 0),o++;continue}for(;a<n.index;)a++,c.nodeName==="TEMPLATE"&&(e.push(c),s.currentNode=c.content),(c=s.nextNode())===null&&(s.currentNode=e.pop(),c=s.nextNode());if(n.type==="node"){let d=this.processor.handleTextExpression(this.options);d.insertAfterNode(c.previousSibling),this.__parts.push(d)}else this.__parts.push(...this.processor.handleAttributeExpressions(c,n.name,n.strings,this.options));o++}return Dt&&(document.adoptNode(t),customElements.upgrade(t)),t}};var Ve=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:r=>r}),Ai=` ${A} `,L=class{constructor(t,e,i,s){this.strings=t,this.values=e,this.type=i,this.processor=s}getHTML(){let t=this.strings.length-1,e="",i=!1;for(let s=0;s<t;s++){let o=this.strings[s],a=o.lastIndexOf("<!--");i=(a>-1||i)&&o.indexOf("-->",a+1)===-1;let n=gt.exec(o);n===null?e+=o+(i?Ai:Ut):e+=o.substr(0,n.index)+n[1]+n[2]+K+n[3]+A}return e+=this.strings[t],e}getTemplateElement(){let t=document.createElement("template"),e=this.getHTML();return Ve!==void 0&&(e=Ve.createHTML(e)),t.innerHTML=e,t}},X=class extends L{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){let t=super.getTemplateElement(),e=t.content,i=e.firstChild;return e.removeChild(i),Ht(e,i.firstChild),t}};var J=r=>r===null||!(typeof r=="object"||typeof r=="function"),bt=r=>Array.isArray(r)||!!(r&&r[Symbol.iterator]),Z=class{constructor(t,e,i){this.dirty=!0,this.element=t,this.name=e,this.strings=i,this.parts=[];for(let s=0;s<i.length-1;s++)this.parts[s]=this._createPart()}_createPart(){return new rt(this)}_getValue(){let t=this.strings,e=t.length-1,i=this.parts;if(e===1&&t[0]===""&&t[1]===""){let o=i[0].value;if(typeof o=="symbol")return String(o);if(typeof o=="string"||!bt(o))return o}let s="";for(let o=0;o<e;o++){s+=t[o];let a=i[o];if(a!==void 0){let n=a.value;if(J(n)||!bt(n))s+=typeof n=="string"?n:String(n);else for(let c of n)s+=typeof c=="string"?c:String(c)}}return s+=t[e],s}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}},rt=class{constructor(t){this.value=void 0,this.committer=t}setValue(t){t!==C&&(!J(t)||t!==this.value)&&(this.value=t,H(t)||(this.committer.dirty=!0))}commit(){for(;H(this.value);){let t=this.value;this.value=C,t(this)}this.value!==C&&this.committer.commit()}},I=class r{constructor(t){this.value=void 0,this.__pendingValue=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(P()),this.endNode=t.appendChild(P())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.__insert(this.startNode=P()),t.__insert(this.endNode=P())}insertAfterPart(t){t.__insert(this.startNode=P()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.__pendingValue=t}commit(){if(this.startNode.parentNode===null)return;for(;H(this.__pendingValue);){let e=this.__pendingValue;this.__pendingValue=C,e(this)}let t=this.__pendingValue;t!==C&&(J(t)?t!==this.value&&this.__commitText(t):t instanceof L?this.__commitTemplateResult(t):t instanceof Node?this.__commitNode(t):bt(t)?this.__commitIterable(t):t===mt?(this.value=mt,this.clear()):this.__commitText(t))}__insert(t){this.endNode.parentNode.insertBefore(t,this.endNode)}__commitNode(t){this.value!==t&&(this.clear(),this.__insert(t),this.value=t)}__commitText(t){let e=this.startNode.nextSibling;t=t??"";let i=typeof t=="string"?t:String(t);e===this.endNode.previousSibling&&e.nodeType===3?e.data=i:this.__commitNode(document.createTextNode(i)),this.value=t}__commitTemplateResult(t){let e=this.options.templateFactory(t);if(this.value instanceof O&&this.value.template===e)this.value.update(t.values);else{let i=new O(e,t.processor,this.options),s=i._clone();i.update(t.values),this.__commitNode(s),this.value=i}}__commitIterable(t){Array.isArray(this.value)||(this.value=[],this.clear());let e=this.value,i=0,s;for(let o of t)s=e[i],s===void 0&&(s=new r(this.options),e.push(s),i===0?s.appendIntoPart(this):s.insertAfterPart(e[i-1])),s.setValue(o),s.commit(),i++;i<e.length&&(e.length=i,this.clear(s&&s.endNode))}clear(t=this.startNode){F(this.startNode.parentNode,t.nextSibling,this.endNode)}},ot=class{constructor(t,e,i){if(this.value=void 0,this.__pendingValue=void 0,i.length!==2||i[0]!==""||i[1]!=="")throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=i}setValue(t){this.__pendingValue=t}commit(){for(;H(this.__pendingValue);){let e=this.__pendingValue;this.__pendingValue=C,e(this)}if(this.__pendingValue===C)return;let t=!!this.__pendingValue;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.__pendingValue=C}},at=class extends Z{constructor(t,e,i){super(t,e,i),this.single=i.length===2&&i[0]===""&&i[1]===""}_createPart(){return new vt(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}},vt=class extends rt{},Fe=!1;(()=>{try{let r={get capture(){return Fe=!0,!1}};window.addEventListener("test",r,r),window.removeEventListener("test",r,r)}catch{}})();var nt=class{constructor(t,e,i){this.value=void 0,this.__pendingValue=void 0,this.element=t,this.eventName=e,this.eventContext=i,this.__boundHandleEvent=s=>this.handleEvent(s)}setValue(t){this.__pendingValue=t}commit(){for(;H(this.__pendingValue);){let o=this.__pendingValue;this.__pendingValue=C,o(this)}if(this.__pendingValue===C)return;let t=this.__pendingValue,e=this.value,i=t==null||e!=null&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),s=t!=null&&(e==null||i);i&&this.element.removeEventListener(this.eventName,this.__boundHandleEvent,this.__options),s&&(this.__options=Pi(t),this.element.addEventListener(this.eventName,this.__boundHandleEvent,this.__options)),this.value=t,this.__pendingValue=C}handleEvent(t){typeof this.value=="function"?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}},Pi=r=>r&&(Fe?{capture:r.capture,passive:r.passive,once:r.once}:r.capture);function Qt(r){let t=U.get(r.type);t===void 0&&(t={stringsArray:new WeakMap,keyString:new Map},U.set(r.type,t));let e=t.stringsArray.get(r.strings);if(e!==void 0)return e;let i=r.strings.join(A);return e=t.keyString.get(i),e===void 0&&(e=new D(r,r.getTemplateElement()),t.keyString.set(i,e)),t.stringsArray.set(r.strings,e),e}var U=new Map;var j=new WeakMap,Gt=(r,t,e)=>{let i=j.get(t);i===void 0&&(F(t,t.firstChild),j.set(t,i=new I(Object.assign({templateFactory:Qt},e))),i.appendInto(t)),i.setValue(r),i.commit()};var xt=class{handleAttributeExpressions(t,e,i,s){let o=e[0];return o==="."?new at(t,e.slice(1),i).parts:o==="@"?[new nt(t,e.slice(1),s.eventContext)]:o==="?"?[new ot(t,e.slice(1),i)]:new Z(t,e,i).parts}handleTextExpression(t){return new I(t)}},_t=new xt;typeof window<"u"&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");var l=(r,...t)=>new L(r,t,"html",_t),S=(r,...t)=>new X(r,t,"svg",_t);var De=(r,t)=>`${r}--${t}`,yt=!0;typeof window.ShadyCSS>"u"?yt=!1:typeof window.ShadyCSS.prepareTemplateDom>"u"&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),yt=!1);var Li=r=>t=>{let e=De(t.type,r),i=U.get(e);i===void 0&&(i={stringsArray:new WeakMap,keyString:new Map},U.set(e,i));let s=i.stringsArray.get(t.strings);if(s!==void 0)return s;let o=t.strings.join(A);if(s=i.keyString.get(o),s===void 0){let a=t.getTemplateElement();yt&&window.ShadyCSS.prepareTemplateDom(a,r),s=new D(t,a),i.keyString.set(o,s)}return i.stringsArray.set(t.strings,s),s},Ni=["html","svg"],Ii=r=>{Ni.forEach(t=>{let e=U.get(De(t,r));e!==void 0&&e.keyString.forEach(i=>{let{element:{content:s}}=i,o=new Set;Array.from(s.querySelectorAll("style")).forEach(a=>{o.add(a)}),Yt(i,o)})})},He=new Set,Ri=(r,t,e)=>{He.add(r);let i=e?e.element:document.createElement("template"),s=t.querySelectorAll("style"),{length:o}=s;if(o===0){window.ShadyCSS.prepareTemplateStyles(i,r);return}let a=document.createElement("style");for(let d=0;d<o;d++){let u=s[d];u.parentNode.removeChild(u),a.textContent+=u.textContent}Ii(r);let n=i.content;e?je(e,a,n.firstChild):n.insertBefore(a,n.firstChild),window.ShadyCSS.prepareTemplateStyles(i,r);let c=n.querySelector("style");if(window.ShadyCSS.nativeShadow&&c!==null)t.insertBefore(c.cloneNode(!0),t.firstChild);else if(e){n.insertBefore(a,n.firstChild);let d=new Set;d.add(a),Yt(e,d)}},Ue=(r,t,e)=>{if(!e||typeof e!="object"||!e.scopeName)throw new Error("The `scopeName` option is required.");let i=e.scopeName,s=j.has(t),o=yt&&t.nodeType===11&&!!t.host,a=o&&!He.has(i),n=a?document.createDocumentFragment():t;if(Gt(r,n,Object.assign({templateFactory:Li(i)},e)),a){let c=j.get(n);j.delete(n);let d=c.value instanceof O?c.value.template:void 0;Ri(i,n,d),F(t,t.firstChild),t.appendChild(n),j.set(t,c)}!s&&o&&window.ShadyCSS.styleElement(t.host)};var qe;window.JSCompiler_renameProperty=(r,t)=>r;var ee={toAttribute(r,t){switch(t){case Boolean:return r?"":null;case Object:case Array:return r==null?r:JSON.stringify(r)}return r},fromAttribute(r,t){switch(t){case Boolean:return r!==null;case Number:return r===null?null:Number(r);case Object:case Array:return JSON.parse(r)}return r}},Ye=(r,t)=>t!==r&&(t===t||r===r),Kt={attribute:!0,type:String,converter:ee,reflect:!1,hasChanged:Ye},Xt=1,Zt=4,Jt=8,te=16,ie="finalized",tt=class extends HTMLElement{constructor(){super(),this.initialize()}static get observedAttributes(){this.finalize();let t=[];return this._classProperties.forEach((e,i)=>{let s=this._attributeNameForProperty(i,e);s!==void 0&&(this._attributeToPropertyMap.set(s,i),t.push(s))}),t}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;let t=Object.getPrototypeOf(this)._classProperties;t!==void 0&&t.forEach((e,i)=>this._classProperties.set(i,e))}}static createProperty(t,e=Kt){if(this._ensureClassProperties(),this._classProperties.set(t,e),e.noAccessor||this.prototype.hasOwnProperty(t))return;let i=typeof t=="symbol"?Symbol():`__${t}`,s=this.getPropertyDescriptor(t,i,e);s!==void 0&&Object.defineProperty(this.prototype,t,s)}static getPropertyDescriptor(t,e,i){return{get(){return this[e]},set(s){let o=this[t];this[e]=s,this.requestUpdateInternal(t,o,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this._classProperties&&this._classProperties.get(t)||Kt}static finalize(){let t=Object.getPrototypeOf(this);if(t.hasOwnProperty(ie)||t.finalize(),this[ie]=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){let e=this.properties,i=[...Object.getOwnPropertyNames(e),...typeof Object.getOwnPropertySymbols=="function"?Object.getOwnPropertySymbols(e):[]];for(let s of i)this.createProperty(s,e[s])}}static _attributeNameForProperty(t,e){let i=e.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}static _valueHasChanged(t,e,i=Ye){return i(t,e)}static _propertyValueFromAttribute(t,e){let i=e.type,s=e.converter||ee,o=typeof s=="function"?s:s.fromAttribute;return o?o(t,i):t}static _propertyValueToAttribute(t,e){if(e.reflect===void 0)return;let i=e.type,s=e.converter;return(s&&s.toAttribute||ee.toAttribute)(t,i)}initialize(){this._updateState=0,this._updatePromise=new Promise(t=>this._enableUpdatingResolver=t),this._changedProperties=new Map,this._saveInstanceProperties(),this.requestUpdateInternal()}_saveInstanceProperties(){this.constructor._classProperties.forEach((t,e)=>{if(this.hasOwnProperty(e)){let i=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,i)}})}_applyInstanceProperties(){this._instanceProperties.forEach((t,e)=>this[e]=t),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){this._enableUpdatingResolver!==void 0&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(t,e,i){e!==i&&this._attributeToProperty(t,i)}_propertyToAttribute(t,e,i=Kt){let s=this.constructor,o=s._attributeNameForProperty(t,i);if(o!==void 0){let a=s._propertyValueToAttribute(e,i);if(a===void 0)return;this._updateState=this._updateState|Jt,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._updateState=this._updateState&~Jt}}_attributeToProperty(t,e){if(this._updateState&Jt)return;let i=this.constructor,s=i._attributeToPropertyMap.get(t);if(s!==void 0){let o=i.getPropertyOptions(s);this._updateState=this._updateState|te,this[s]=i._propertyValueFromAttribute(e,o),this._updateState=this._updateState&~te}}requestUpdateInternal(t,e,i){let s=!0;if(t!==void 0){let o=this.constructor;i=i||o.getPropertyOptions(t),o._valueHasChanged(this[t],e,i.hasChanged)?(this._changedProperties.has(t)||this._changedProperties.set(t,e),i.reflect===!0&&!(this._updateState&te)&&(this._reflectingProperties===void 0&&(this._reflectingProperties=new Map),this._reflectingProperties.set(t,i))):s=!1}!this._hasRequestedUpdate&&s&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(t,e){return this.requestUpdateInternal(t,e),this.updateComplete}async _enqueueUpdate(){this._updateState=this._updateState|Zt;try{await this._updatePromise}catch{}let t=this.performUpdate();return t!=null&&await t,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return this._updateState&Zt}get hasUpdated(){return this._updateState&Xt}performUpdate(){if(!this._hasRequestedUpdate)return;this._instanceProperties&&this._applyInstanceProperties();let t=!1,e=this._changedProperties;try{t=this.shouldUpdate(e),t?this.update(e):this._markUpdated()}catch(i){throw t=!1,this._markUpdated(),i}t&&(this._updateState&Xt||(this._updateState=this._updateState|Xt,this.firstUpdated(e)),this.updated(e))}_markUpdated(){this._changedProperties=new Map,this._updateState=this._updateState&~Zt}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._updatePromise}shouldUpdate(t){return!0}update(t){this._reflectingProperties!==void 0&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach((e,i)=>this._propertyToAttribute(i,this[i],e)),this._reflectingProperties=void 0),this._markUpdated()}updated(t){}firstUpdated(t){}};qe=ie;tt[qe]=!0;var We=Element.prototype,Er=We.msMatchesSelector||We.webkitMatchesSelector;var wt=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,se=Symbol(),lt=class{constructor(t,e){if(e!==se)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){return this._styleSheet===void 0&&(wt?(this._styleSheet=new CSSStyleSheet,this._styleSheet.replaceSync(this.cssText)):this._styleSheet=null),this._styleSheet}toString(){return this.cssText}},Qe=r=>new lt(String(r),se),Oi=r=>{if(r instanceof lt)return r.cssText;if(typeof r=="number")return r;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${r}. Use 'unsafeCSS' to pass non-literal values, but
            take care to ensure page security.`)},y=(r,...t)=>{let e=t.reduce((i,s,o)=>i+Oi(s)+r[o+1],r[0]);return new lt(e,se)};(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");var Ge={},v=class extends tt{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;let t=this.getStyles();if(Array.isArray(t)){let e=(o,a)=>o.reduceRight((n,c)=>Array.isArray(c)?e(c,n):(n.add(c),n),a),i=e(t,new Set),s=[];i.forEach(o=>s.unshift(o)),this._styles=s}else this._styles=t===void 0?[]:[t];this._styles=this._styles.map(e=>{if(e instanceof CSSStyleSheet&&!wt){let i=Array.prototype.slice.call(e.cssRules).reduce((s,o)=>s+o.cssText,"");return Qe(i)}return e})}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow(this.constructor.shadowRootOptions)}adoptStyles(){let t=this.constructor._styles;t.length!==0&&(window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow?window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(e=>e.cssText),this.localName):wt?this.renderRoot.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):this._needsShimAdoptedStyleSheets=!0)}connectedCallback(){super.connectedCallback(),this.hasUpdated&&window.ShadyCSS!==void 0&&window.ShadyCSS.styleElement(this)}update(t){let e=this.render();super.update(t),e!==Ge&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(i=>{let s=document.createElement("style");s.textContent=i.cssText,this.renderRoot.appendChild(s)}))}render(){return Ge}};v.finalized=!0;v.render=Ue;v.shadowRootOptions={mode:"open"};var re={blue:["#dcecf8","#2e618c"],mint:["#ddf0e7","#306b55"],peach:["#f9e6d9","#8f5538"],lavender:["#ece5f7","#6d558c"],pink:["#f7e1ed","#8e496e"],amber:["#f5edcf","#786022"],green:["#ddf0e7","#306b55"],purple:["#ece5f7","#6d558c"],orange:["#f9e6d9","#8f5538"],teal:["#d9efec","#306b65"],red:["#f7e1df","#963f3b"]},Ke=y`
...
`;var R=class extends v{static get properties(){return{hass:{},config:{},error:{},busy:{}}}static get styles(){return Ke}setConfig(t){this.config={...t},this.error=""}getCardSize(){return 5}getGridOptions(){return{columns:6,min_columns:3,rows:"auto"}}palette(t="blue"){let[e,i]=re[t]||re.blue;return`--p-tint:${e};--p-accent:${i}`}info(t){t&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t},bubbles:!0,composed:!0}))}async call(t,e,i={},s){if(this.busy)return;let[o,a]=String(t||"").split(".");if(!o||!a||!this.hass?.services?.[o]?.[a]){this.error="Questo comando non \xE8 disponibile.";return}this.busy=!0,this.error="";try{await this.hass.callService(o,a,{...i,...e?{entity_id:e}:{}},s)}catch(n){this.error=n.message||"Comando non riuscito."}finally{this.busy=!1}}guardPress(t){this._origin={x:t.clientX,y:t.clientY,id:t.pointerId},this._moved=!1}guardMove(t){this._origin?.id===t.pointerId&&Math.hypot(t.clientX-this._origin.x,t.clientY-this._origin.y)>10&&(this._moved=!0)}guardCancel(){this._moved=!0}guardClick(t){t.detail!==0&&this._moved&&(t.stopPropagation(),t.preventDefault())}connectedCallback(){super.connectedCallback(),this._down=t=>this.guardPress(t),this._move=t=>this.guardMove(t),this._cancel=()=>this.guardCancel(),this._click=t=>this.guardClick(t),this.addEventListener("pointerdown",this._down,!0),this.addEventListener("pointermove",this._move,!0),this.addEventListener("pointercancel",this._cancel,!0),this.addEventListener("click",this._click,!0)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("pointerdown",this._down,!0),this.removeEventListener("pointermove",this._move,!0),this.removeEventListener("pointercancel",this._cancel,!0),this.removeEventListener("click",this._click,!0)}feedback(){return this.error?l`<div class="error" role="alert">${this.error}</div>`:""}},q=r=>({on:"Acceso",off:"Spento",unavailable:"Non disponibile",unknown:"Stato sconosciuto",cleaning:"In pulizia",mowing:"In taglio",docked:"Alla base",paused:"In pausa",returning:"Ritorno alla base",idle:"In attesa",error:"Richiede attenzione",running:"In funzione",washing:"Lavaggio",drying:"Asciugatura",finished:"Terminato",cool:"Raffreddamento",heat:"Riscaldamento",auto:"Automatico",heat_cool:"Caldo / freddo",dry:"Deumidificazione",fan_only:"Ventilazione"})[r]||r||"Non configurato";var B={washer:["Lavatrice","mdi:washing-machine","blue","washer|washing machine|lavatrice"],dryer:["Asciugatrice","mdi:tumble-dryer","peach","dryer|asciugatrice"],dishwasher:["Lavastoviglie","mdi:dishwasher","blue","dishwasher|lavastoviglie"],refrigerator:["Frigorifero","mdi:fridge-outline","mint","refrigerator|fridge|frigorifero"],freezer:["Congelatore","mdi:fridge-bottom","blue","freezer|congelatore"],wine_cooler:["Cantinetta","mdi:glass-wine","lavender","wine cooler|cantinetta"],oven:["Forno","mdi:stove","peach","oven|forno"],microwave:["Microonde","mdi:microwave","peach","microwave|microonde"],coffee:["Macchina del caff\xE8","mdi:coffee-maker-outline","peach","coffee|caffe|caff\xE8"],hood:["Cappa","mdi:air-filter","mint","hood|cappa"],hob:["Piano induzione","mdi:stove","peach","hob|cooktop|induzione|piano cottura|pianocottura"],dehumidifier:["Deumidificatore","mdi:air-humidifier-off","blue","dehumidifier|deumidificatore"],humidifier:["Umidificatore","mdi:air-humidifier","blue","humidifier|umidificatore"],air_purifier:["Purificatore aria","mdi:air-purifier","mint","air purifier|purificatore aria"],water_purifier:["Depuratore acqua","mdi:water-check-outline","mint","water purifier|water filter|reverse osmosis|depuratore|osmosi"],fan:["Ventilatore","mdi:fan","mint","fan|ventilatore"],ventilation:["Ventilazione","mdi:hvac","mint","ventilation|ventilazione|vmc"],water_heater:["Scaldacqua","mdi:water-boiler","peach","water heater|boiler|scaldacqua"],vacuum:["Robot pulizia","mdi:robot-vacuum","lavender","vacuum|aspirapolvere|robot pulizia"],floor_cleaner:["Lavapavimenti","mdi:vacuum-outline","lavender","floor cleaner|lavapavimenti|aspirapavimenti"],lawn_mower:["Tagliaerba","mdi:robot-mower-outline","mint","lawn mower|tagliaerba"],robot_dock:["Base di pulizia","mdi:robot-vacuum","lavender","dock|base lavaggio|base svuotamento|base di pulizia"],generic:["Dispositivo","mdi:devices","blue","^$"]},ct=["vacuum","floor_cleaner","lawn_mower","robot_dock"],Y={power:["Potenza","power"],energy:["Energia totale","energy"],cycle_energy:["Energia ciclo",null],remaining:["Tempo restante",null],progress:["Avanzamento",null],temperature:["Temperatura","temperature"],humidity:["Umidit\xE0","humidity"],battery:["Batteria","battery"],water_quality:["TDS uscita",null],water_input:["TDS ingresso",null],water_used:["Acqua erogata",null],tank:["Serbatoio",null],filter:["Filtro residuo",null],area:["Area pulita",null]},M=r=>(r||"").split(".")[0],V=r=>!!r&&!["unknown","unavailable"].includes(r.state),E=r=>r==null||String(r).trim()===""||!Number.isFinite(Number(r))?null:Number(r);function $t(r,t={}){let e=M(r?.entity_id);if(e==="vacuum"||e==="lawn_mower"||e==="water_heater")return e;if(e==="humidifier")return r.attributes?.device_class==="dehumidifier"?"dehumidifier":"humidifier";let i=[t.name_by_user,t.name,t.model,r?.attributes?.friendly_name,r?.entity_id].filter(Boolean).join(" ").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replaceAll("_"," "),s=Object.entries(B).filter(([o,a])=>o!=="generic"&&new RegExp(`(^|\\b)(${a[3]})(\\b|$)`,"i").test(i));return s.length===1?s[0][0]:"generic"}function oe(r,t,e){let i=t?.entities||[],s=i.find(f=>f.entity_id===e.entity),o=e.device_id||s?.device_id,a=o?i.filter(f=>f.device_id===o&&!f.disabled_by).map(f=>f.entity_id):[e.entity].filter(Boolean),n=(t?.devices||[]).find(f=>f.id===o)||{},c=a.map(f=>r.states[f]).filter(Boolean),d=r.states[e.entity]||c.find(f=>["vacuum","lawn_mower","humidifier","water_heater","fan"].includes(M(f.entity_id)))||c[0],u={},p=[];for(let[f,[,b]]of Object.entries(Y)){let _=c.filter(w=>M(w.entity_id)==="sensor"&&(b?w.attributes?.device_class===b&&(f!=="energy"||!Xe("cycle_energy",w)):Xe(f,w)));_.length===1?u[f]=_[0].entity_id:_.length>1&&p.push(f)}let h=c.filter(f=>["button","select","number","switch","input_button","input_select","input_number","input_boolean","fan","humidifier"].includes(M(f.entity_id))).map(f=>({entity:f.entity_id,name:f.attributes?.friendly_name||f.entity_id})),g=c.filter(f=>["camera","image"].includes(M(f.entity_id)));return{status_entities:c.filter(f=>f.entity_id!==d?.entity_id&&(M(f.entity_id)==="binary_sensor"||M(f.entity_id)==="sensor"&&E(f.state)===null&&/filter|filtro|maintenance|manutenzione|tank|serbatoio|salt|sale|rinse|brillantante/i.test(f.entity_id+" "+f.attributes?.friendly_name))).map(f=>f.entity_id),entity:d?.entity_id||"",profile:$t(d,n),metrics:u,controls:h,map_entity:g.length===1?g[0].entity_id:"",device_id:o,ambiguous:p,siblings:a}}function Xe(r,t){let e=(t.entity_id+" "+(t.attributes?.friendly_name||"")).toLowerCase();return{cycle_energy:/cycle.*energy|energia.*ciclo/,remaining:/remaining|restante|residuo.*tempo/,progress:/progress|avanzamento/,water_quality:/(tds.*(out|uscita|purified))|((out|uscita|purified).*tds)/,water_input:/(tds.*(inlet|ingresso|input))|((inlet|ingresso|input).*tds)/,water_used:/water.*(used|dispensed)|acqua.*(erogata|consumata)/,tank:/tank|serbatoio/,filter:/filter.*(life|remaining)|filtro.*residu/,area:/cleaned.*area|area.*(pulita|tagliata)/}[r]?.test(e)||!1}function Ze(r,t={}){if(!r)return[];let e=M(r.entity_id),i=Number(r.attributes?.supported_features||0);return(e==="vacuum"?[[8192,"start","Avvia"],[4,"pause","Pausa"],[8,"stop","Ferma"],[16,"return_to_base","Alla base"],[512,"locate","Trova"]]:e==="lawn_mower"?[[1,"start_mowing","Taglia"],[2,"pause","Pausa"],[4,"dock","Alla base"],[8,"stop","Ferma"]]:[]).filter(([o,a])=>i&o&&t[e]?.[a]).map(([,o,a])=>({name:a,action:`${e}.${o}`,entity:r.entity_id}))}function Je(r,t){if(!V(t))return null;let e=E(t.state);if(e===null)return null;let i=t.attributes?.unit_of_measurement||"";return r==="power"?i==="kW"?{value:e*1e3,unit:"W"}:i==="W"?{value:e,unit:i}:null:r==="energy"||r==="cycle_energy"?i==="Wh"?{value:e/1e3,unit:"kWh"}:i==="kWh"?{value:e,unit:i}:null:{value:e,unit:i}}function ti(r){let t=["power","energy"],e=["cycle_energy","remaining","progress"],i=r==="water_purifier"?["water_quality","water_input","water_used","tank","filter"]:["vacuum","floor_cleaner","lawn_mower","robot_dock"].includes(r)?["battery","area","remaining","progress","tank","filter"]:["washer","dryer","dishwasher","oven","microwave","coffee"].includes(r)?[...e,"temperature","tank","filter"]:["refrigerator","freezer","wine_cooler","water_heater"].includes(r)?["temperature"]:["humidity","temperature","filter","tank"];return r==="generic"?Object.keys(Y):[...t,...i]}function kt(r){let t;return r==="dishwasher"?t=S`<rect x="21" y="10" width="78" height="99" rx="14"/><path d="M21 35h78M32 23h20M36 80h48M36 91h48"/><path d="M42 76V49M54 76V45M66 76V45M78 76V49"/>`:r==="oven"?t=S`<rect x="21" y="10" width="78" height="99" rx="14"/><rect x="32" y="44" width="56" height="50" rx="6"/><path d="M38 24h10M69 24h10M40 82h40"/>`:r==="microwave"?t=S`<rect x="10" y="28" width="100" height="67" rx="12"/><rect x="21" y="40" width="62" height="42" rx="6"/><circle cx="97" cy="49" r="3"/><circle cx="97" cy="65" r="3"/>`:r==="hob"?t=S`<rect x="13" y="17" width="94" height="86" rx="12"/><circle cx="38" cy="42" r="15"/><circle cx="80" cy="42" r="13"/><circle cx="39" cy="79" r="13"/><circle cx="80" cy="78" r="16"/>`:r==="hood"?t=S`<path d="M45 12h30v38l30 30H15l30-30Z"/><path d="M15 80v12h90V80M40 107h40M44 69h32"/>`:r==="coffee"?t=S`<rect x="25" y="13" width="70" height="94" rx="12"/><path d="M35 43h50M55 44v14M40 96h42"/><path d="M43 66h31v18H43ZM74 68h10v10H74"/>`:r==="generic"?t=S`<rect x="15" y="20" width="40" height="40" rx="10"/><rect x="65" y="20" width="40" height="40" rx="10"/><rect x="15" y="70" width="40" height="40" rx="10"/><path d="M66 90h38M85 71v38"/>`:r==="water_purifier"?t=S`<rect x="22" y="12" width="72" height="94" rx="18"/><path d="M36 36h44M42 48h32M48 61v18h25V61M48 88h25"/><path d="M60 57c-10-12 0-20 0-20s10 8 0 20Z" fill="currentColor" opacity=".25"/>`:["vacuum","floor_cleaner","robot_dock"].includes(r)?t=S`<circle cx="60" cy="64" r="42"/><circle cx="60" cy="64" r="32" opacity=".35"/><rect x="47" y="24" width="26" height="20" rx="9"/><path d="M45 82h30M56 57h8"/>`:r==="lawn_mower"?t=S`<rect x="18" y="49" width="84" height="42" rx="19"/><rect x="38" y="30" width="42" height="35" rx="14"/><circle cx="34" cy="91" r="12"/><circle cx="86" cy="91" r="12"/><path d="M49 42h20"/>`:["refrigerator","freezer","wine_cooler"].includes(r)?t=S`<rect x="27" y="9" width="65" height="101" rx="13"/><path d="M27 47h65M40 26v10M40 62v16"/>`:r==="climate"?t=S`<rect x="9" y="22" width="102" height="48" rx="13"/><path d="M20 54h80M29 64h62M32 82v16M60 82v24M88 82v16"/><circle cx="94" cy="37" r="2" fill="currentColor"/>`:["dehumidifier","humidifier","air_purifier","fan","ventilation","water_heater"].includes(r)?t=S`<rect x="28" y="13" width="64" height="95" rx="20"/><path d="M41 30h38M41 38h38M41 46h38M46 87h28"/><circle cx="60" cy="66" r="5"/>`:t=S`<rect x="21" y="10" width="78" height="99" rx="14"/><path d="M21 35h78M32 23h20"/><circle cx="60" cy="70" r="24"/><path d="M40 73q10-9 20 0t20 0" opacity=".5"/><circle cx="83" cy="23" r="3" fill="currentColor"/>`,l`<svg viewBox="0 0 120 120" fill="none" stroke="currentColor" stroke-width="2.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${t}</svg>`}var dt=class extends R{static getConfigElement(){return document.createElement("pastel-appliance-card-editor")}static getStubConfig(){return{profile:"generic",entity:"",metrics:{},controls:[]}}setConfig(t){if(super.setConfig(t),t.controls&&!Array.isArray(t.controls))throw new Error("controls deve essere una lista");if(t.controls?.some(e=>!e||typeof e!="object"||e.action&&typeof e.action!="string"))throw new Error("Ogni controllo deve indicare entity oppure action come testo");if(t.status_entities&&!Array.isArray(t.status_entities))throw new Error("status_entities deve essere una lista");if(t.zones&&!Array.isArray(t.zones))throw new Error("zones deve essere una lista");if(t.metrics&&(typeof t.metrics!="object"||Array.isArray(t.metrics)))throw new Error("metrics deve essere un oggetto")}render(){if(!this.hass||!this.config)return l``;let t=this.config,e=B[t.profile]||B.generic,i=this.hass.states[t.entity],s=t.title||e[0],o=V(i),a=t.metrics||{};return l`<ha-card style=${this.palette(t.color||e[2])}>
   <header><div class="icon"><ha-icon icon=${e[1]}></ha-icon></div><div class="heading"><h2>${s}</h2><div class="subtitle">${t.subtitle||e[0]}</div></div><span class="pill">${q(i?.state)}</span></header>
   <div class="hero">${kt(t.profile)}<div class="right"><div class="status">${q(i?.state)}</div><div class="caption">${i?.attributes?.friendly_name||"Scegli il dispositivo nell\u2019editor"}</div></div></div>
   ${Object.keys(a).length?l`<div class="metrics">${Object.entries(a).filter(([,n])=>n).map(([n,c])=>{let d=Je(n,this.hass.states[c]);return l`<button class="metric" @click=${()=>this.info(c)}><small>${Y[n]?.[0]||n}</small><strong>${d?new Intl.NumberFormat(this.hass.locale?.language||"it",{maximumFractionDigits:2}).format(d.value):"\u2014"}<span class="unit">${d?.unit||""}</span></strong></button>`})}</div>`:""}
   <div class="actions">${Ze(i,this.hass.services).filter(n=>!(t.hidden_actions||[]).includes(n.action)).map(n=>l`<button ?disabled=${!o||this.busy} @click=${()=>this.call(n.action,n.entity)}>${n.name}</button>`)}</div>
   ${this.nativeSettings(i)}
   ${(t.controls||[]).map(n=>this.control(n))}
   ${(t.status_entities||[]).length?l`<h3>Stato e manutenzione</h3>${t.status_entities.map(n=>{let c=this.hass.states[n];return l`<div class="control"><span>${c?.attributes?.friendly_name||n}</span><button @click=${()=>this.info(n)}>${q(c?.state)}</button></div>`})}`:""}
   ${this.robotExtras()}
   ${t.entity?"":l`<div class="empty">Apri l’editor, scegli un dispositivo e controlla le associazioni suggerite.</div>`}
   ${this.feedback()}
  </ha-card>`}control(t){if(t.action)return l`<div class="control"><span>${t.name||"Azione"}</span><button ?disabled=${this.busy||!this.hass.services?.[t.action.split(".")[0]]?.[t.action.split(".")[1]]} @click=${()=>this.call(t.action,t.entity,t.data||{},t.target)}>${t.button_label||"Esegui"}</button></div>`;let e=this.hass.states[t.entity],i=M(t.entity),s=t.name||e?.attributes?.friendly_name||t.entity,o=!e||e.state==="unavailable"||!["button","input_button"].includes(i)&&e.state==="unknown"||this.busy;if(["script","scene"].includes(i))return l`<div class="control"><span>${s}</span><button ?disabled=${o||!this.hass.services?.[i]?.turn_on} @click=${()=>this.call(`${i}.turn_on`,t.entity)}>Esegui</button></div>`;if(["select","input_select"].includes(i))return l`<label class="control"><span>${s}</span><select aria-label=${s} ?disabled=${o||!this.hass.services?.[i]?.select_option} .value=${e?.state||""} @change=${a=>this.call(`${i}.select_option`,t.entity,{option:a.target.value})}><option value="" disabled>Scegli</option>${(e?.attributes?.options||[]).map(a=>l`<option value=${a} ?selected=${a===e.state}>${a}</option>`)}</select></label>`;if(["number","input_number"].includes(i))return l`<label class="control"><span>${s}</span><input aria-label=${s} type="number" ?disabled=${o||!this.hass.services?.[i]?.set_value} min=${e?.attributes?.min??0} max=${e?.attributes?.max??100} step=${e?.attributes?.step??1} .value=${V(e)?e.state:""} @change=${a=>{a.target.checkValidity()&&E(a.target.value)!==null&&this.call(`${i}.set_value`,t.entity,{value:Number(a.target.value)})}}></label>`;if(["button","input_button"].includes(i))return l`<div class="control"><span>${s}</span><button ?disabled=${o||!this.hass.services?.[i]?.press} @click=${()=>this.call(`${i}.press`,t.entity)}>${t.button_label||"Esegui"}</button></div>`;if(["switch","input_boolean","fan","humidifier"].includes(i)){let a=e?.state==="on"?"turn_off":"turn_on";return l`<div class="control"><span>${s}<br><small class="muted">Alimentazione</small></span><button ?disabled=${o||!this.hass.services?.[i]?.[a]} @click=${()=>this.call(`${i}.${a}`,t.entity)}>${e?.state==="on"?"Spegni":"Accendi"}</button></div>`}return l`<div class="control"><span>${s}</span><button @click=${()=>this.info(t.entity)}>Dettagli</button></div>`}nativeSettings(t){if(!t)return"";let e=M(t.entity_id),i=t.attributes||{},s=this.hass.services?.[e]||{},o=!t||t.state==="unavailable"||!["button","input_button"].includes(e)&&t.state==="unknown"||this.busy,a=(c,d,u,p,h)=>d?.length&&s[p]?l`<label class="control"><span>${c}</span><select aria-label=${c} ?disabled=${o} @change=${g=>this.call(`${e}.${p}`,t.entity_id,{[h]:g.target.value})}>${d.map(g=>l`<option value=${g} ?selected=${g===u}>${g}</option>`)}</select></label>`:"",n=(c,d,u,p,h,g,m)=>E(d)!==null&&s[g]?l`<label class="control"><span>${c}</span><input type="number" aria-label=${c} .value=${String(d)} min=${u} max=${p} step=${h} ?disabled=${o} @change=${f=>{f.target.checkValidity()&&E(f.target.value)!==null&&this.call(`${e}.${g}`,t.entity_id,{[m]:Number(f.target.value)})}}></label>`:"";return e==="vacuum"?Number(i.supported_features)&32?a("Aspirazione",i.fan_speed_list,i.fan_speed,"set_fan_speed","fan_speed"):"":e==="humidifier"?l`${n("Umidit\xE0 desiderata",i.humidity,i.min_humidity??0,i.max_humidity??100,1,"set_humidity","humidity")}${Number(i.supported_features)&1?a("Modalit\xE0",i.available_modes,i.mode,"set_mode","mode"):""}`:e==="fan"?l`${Number(i.supported_features)&1?n("Velocit\xE0 %",i.percentage,0,100,i.percentage_step||1,"set_percentage","percentage"):""}${Number(i.supported_features)&8?a("Profilo",i.preset_modes,i.preset_mode,"set_preset_mode","preset_mode"):""}`:e==="water_heater"?l`${Number(i.supported_features)&1?n("Temperatura desiderata",i.temperature,i.min_temp??30,i.max_temp??90,1,"set_temperature","temperature"):""}${Number(i.supported_features)&2?a("Modalit\xE0",i.operation_list,i.operation_mode,"set_operation_mode","operation_mode"):""}`:""}robotExtras(){return l``}},Et=class extends dt{static getConfigElement(){return document.createElement("pastel-robot-card-editor")}static getStubConfig(){return{profile:"vacuum",entity:"",metrics:{},controls:[]}}robotExtras(){let t=this.config,e=this.hass.states[t.map_entity],i=V(e)?e.attributes?.entity_picture:null,s=i&&(i.startsWith("/")&&!i.startsWith("//")||/^https?:\/\//.test(i))?this.hass.hassUrl?this.hass.hassUrl(i):i:null;return l`${s?l`<img class="map" src=${s} alt="Mappa del robot" loading="lazy">`:t.map_entity?l`<div class="foot">Mappa non disponibile.</div>`:""}
   ${(t.zones||[]).length?l`<div class="zones"><h3>Stanze e zone</h3>${t.zones.map(o=>this.control(o))}</div>`:""}`}};var St=new WeakMap;async function ae(r,{refresh:t=!1}={}){let e=r.connection||r;if(!t&&St.has(e))return St.get(e);let i=Promise.all([r.callWS({type:"config/entity_registry/list"}),r.callWS({type:"config/device_registry/list"})]).then(([s,o])=>({entities:s,devices:o})).catch(s=>{throw St.delete(e),s});return St.set(e,i),i}function ei(r,t,{robot:e=!1}={}){let i=new Map,s=new Set;for(let a of t.entities||[]){if(s.add(a.entity_id),a.disabled_by||!r.states[a.entity_id])continue;let n=a.device_id?`device:${a.device_id}`:`entity:${a.entity_id}`;i.has(n)||i.set(n,{device_id:a.device_id||"",entities:[]}),i.get(n).entities.push(r.states[a.entity_id])}for(let a of Object.values(r.states))s.has(a.entity_id)||i.set(`entity:${a.entity_id}`,{device_id:"",entities:[a]});let o=[];for(let[a,n]of i){let c=(t.devices||[]).find(g=>g.id===n.device_id)||{},d=$t(null,c),u=n.entities.map(g=>({s:g,profile:d!=="generic"?d:$t(g,c)})).filter(g=>g.profile!=="generic"&&(!e||ct.includes(g.profile)));if([...new Set(u.map(g=>g.profile))].length!==1)continue;let h=u.find(g=>["vacuum","lawn_mower","humidifier","water_heater","fan"].includes(M(g.s.entity_id)))||u.find(g=>/status|state|stato|operation/.test(g.s.entity_id))||u[0];o.push({key:a,device_id:n.device_id,entity:h.s.entity_id,profile:h.profile,name:c.name_by_user||c.name||h.s.attributes.friendly_name||h.s.entity_id,count:n.entities.length})}return o.sort((a,n)=>a.name.localeCompare(n.name))}var ht=class extends R{static get properties(){return{...super.properties,suggestion:{},loading:{},registry:{},showAllMetrics:{}}}updated(){this.hass&&!this._discoveryStarted&&(this._discoveryStarted=!0,this.loadDevices())}chooseCandidate(t){let e=this.detected().find(i=>i.key===t);e&&(this.emit({device_id:e.device_id,entity:e.entity,profile:e.profile,metrics:{},controls:[],map_entity:"",zones:[],status_entities:[]}),this.suggestion={...oe(this.hass,this.registry,e),profile:e.profile})}detected(){return this.hass&&this.registry?ei(this.hass,this.registry,{robot:!!this.constructor.robot}):[]}setConfig(t){super.setConfig(t),this.config={...t,metrics:{...t.metrics||{}},controls:[...t.controls||[]]}}emit(t){this.config={...this.config,...t},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.config},bubbles:!0,composed:!0}))}async scan(){this.loading=!0,this.error="",this.suggestion=null;let t=`${this.config.entity}|${this.config.device_id}`;try{let e=await ae(this.hass,{refresh:!0});this.registry=e,t===`${this.config.entity}|${this.config.device_id}`&&(this.suggestion=oe(this.hass,e,this.config))}catch{this.error="Impossibile leggere i dispositivi. Puoi comunque associare tutte le entit\xE0 manualmente."}finally{this.loading=!1}}async loadDevices(){this.loading=!0;try{this.registry=await ae(this.hass)}catch{this.error="Elenco dispositivi non disponibile: seleziona un\u2019entit\xE0."}finally{this.loading=!1}}options(t){return Object.values(this.hass.states).filter(e=>!t||t.includes(e.entity_id.split(".")[0])).sort((e,i)=>e.entity_id.localeCompare(i.entity_id))}entitySelect(t,e,i,s="Entit\xE0"){return l`<select aria-label=${s} .value=${t||""} @change=${o=>e(o.target.value)}><option value="">Nessuna</option>${this.options(i).map(o=>l`<option value=${o.entity_id} ?selected=${t===o.entity_id}>${o.attributes.friendly_name||o.entity_id} · ${o.entity_id}</option>`)}</select>`}render(){if(!this.config||!this.hass)return l``;let t=this.config,e=this.suggestion,i=this.constructor.robot;return l`<div class="editor" style=${this.palette(t.color)}>
  <label>Elettrodomestici rilevati${this.loading?l`<span class="hint">Ricerca automatica in corso…</span>`:l`<select aria-label="Elettrodomestici rilevati" @change=${s=>this.chooseCandidate(s.target.value)}><option value="">Scegli un dispositivo rilevato</option>${this.detected().map(s=>l`<option value=${s.key} ?selected=${s.device_id?t.device_id===s.device_id:t.entity===s.entity}>${B[s.profile][0]} · ${s.name} (${s.count} entità)</option>`)}</select>`}</label>
  ...
  ${e?l`<div class="hint">${e.siblings.length} entità associate. Profilo proposto: <strong>${B[e.profile][0]}</strong>. Le associazioni verranno salvate solo quando le applichi. ${e.ambiguous.length?`Da scegliere manualmente: ${e.ambiguous.map(s=>Y[s][0]).join(", ")}.`:""}</div><button @click=${()=>{let{siblings:s,ambiguous:o,...a}=e;this.emit({...a,profile:i&&!ct.includes(e.profile)?"vacuum":e.profile}),this.suggestion=null}}>Applica le associazioni proposte</button>`:""}
 ...
 ${s&2&&this.hass.services?.climate?.set_temperature?["target_temp_low","target_temp_high"].map(u=>l`<label class="control"><span>${u==="target_temp_low"?"Temperatura minima":"Temperatura massima"}</span><input type="number" aria-label=${u==="target_temp_low"?"Temperatura minima":"Temperatura massima"} min=${i.min_temp??7} max=${i.max_temp??35} step=${i.target_temp_step??.5} .value=${String(i[u]??"")} ?disabled=${o} @change=${p=>{p.target.checkValidity()&&this.target(p.target.value,u)}}></label>`):""}
 ...
 ${this.feedback()}</ha-card>`}},Ct=class extends R{static get properties(){return{...super.properties}}emit(t){this.config={...this.config,...t},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this.config},bubbles:!0,composed:!0}))}render(){return!this.hass||!this.config?l``:l`<div class="editor" style=${this.palette()}><label>Titolo<input .value=${this.config.title||""} @change=${t=>this.emit({title:t.target.value})}></label>${[["entity","Climatizzatore","climate"],["temp_sensor","Sensore temperatura esterno","sensor"],["humidity_sensor","Sensore umidit\xE0 esterno","sensor"]].map(([t,e,i])=>l`<label>${e}<select @change=${s=>this.emit({[t]:s.target.value})}><option value="">Seleziona</option>${Object.values(this.hass.states).filter(s=>s.entity_id.startsWith(i+".")).map(s=>l`<option value=${s.entity_id} ?selected=${this.config[t]===s.entity_id}>${s.attributes.friendly_name||s.entity_id}</option>`)}</select></label>`)}<p class="hint">Modalità, intervalli e velocità vengono letti dal climatizzatore. I campi temp_sensor e humidity_sensor esistenti restano compatibili.</p></div>`}};var ii=`
...
`;function x(r,t){if(customElements.get(r)){console.warn(`Pastel UI: ${r} gi\xE0 caricato. Rimuovi la vecchia risorsa per usare la versione della suite.`);return}if(r.endsWith("-editor")){customElements.define(r,t);return}if(typeof t.prototype.requestUpdate=="function"){class i extends t{static get styles(){return[super.styles,y([ii])]}}customElements.define(r,i)}else{class i extends t{_render(...o){let a=super._render(...o);if(this.shadowRoot&&!this.shadowRoot.querySelector("[data-pastel-polish]")){let n=document.createElement("style");n.dataset.pastelPolish="",n.textContent=ii,this.shadowRoot.append(n)}return a}}customElements.define(r,i)}}var si=new WeakMap,z=Wt(r=>t=>{if(!(t instanceof I))throw new Error("unsafeHTML can only be used in text bindings");let e=si.get(t);if(e!==void 0&&J(r)&&r===e.value&&t.value===e.fragment)return;let i=document.createElement("template");i.innerHTML=r;let s=document.importNode(i.content,!0);t.setValue(s),si.set(t,{value:r,fragment:s})});var Mt={amber:{base:"#f59e0b",light:"#fde68a",bg:"#fef3c7",glow:"#fef08a",text:"#d97706"},blue:{base:"#3d9cf0",light:"#b8dafc",bg:"#e8f3fe",glow:"#dbeafe",text:"#3d9cf0"},green:{base:"#34c472",light:"#bdeed4",bg:"#e6f9ef",glow:"#dcfce7",text:"#1f9d5c"},pink:{base:"#ec4899",light:"#fbcfe8",bg:"#fce7f3",glow:"#fdf2f8",text:"#db2777"},purple:{base:"#9b5de5",light:"#ddd1f7",bg:"#f3ecff",glow:"#ede9fe",text:"#8b3fd9"},red:{base:"#f05252",light:"#fac9c9",bg:"#fee8e8",glow:"#fef2f2",text:"#e03c3c"},teal:{base:"#20c997",light:"#a8e8d3",bg:"#e6faf4",glow:"#d1fae5",text:"#159b76"},orange:{base:"#f0943d",light:"#fcd9b0",bg:"#fef3e8",glow:"#fff7ed",text:"#d9762a"}},ri=Object.keys(Mt);function ji(r){return Mt[r]||Mt.amber}function Bi(r,t,e=56){let i=t?r.light:"#d8dde3",s=t?r.base:"#b8c0cc",o=t?r.glow:"#eef0f3",a=t?r.light:"#c7cdd6",n=t?r.base:"#aab1bd",c=t?r.text:"#8b93a1",d=Math.round(e*1.32);return`
    <svg width="${e}" height="${d}" viewBox="0 0 44 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <ha-card style="--c-base:${t.base}; --c-light:${t.light}; --c-bg:${t.bg}; --c-glow:${t.glow}; --c-text:${t.text};">
        ...
        <div class="panel rows">
          ${this.config.entities.map((c,d)=>{let u=typeof c=="string"?c:c.entity,p=this.hass.states[u];if(!p)return l`<div class="row missing">Entità non trovata: ${u}</div>`;let h=p.state==="on",g=h&&this._isDimmable(u),m=this._entityLabel(c),f=this._entityIcon(c,h),b=this._brightnessPct(u);return l`
              <div>
                <div
                  class="row ${g?"expanded":""} ${h?"is-on":""}"
                  role="button" tabindex="0" aria-pressed=${h}
                  aria-label=${`${m}: ${h?"spegni":"accendi"}`}
                  @keydown=${_=>this._onKeyDown(u,_)}
                  @pointermove=${_=>this._onPointerMove(_)}
                  @pointercancel=${()=>this._cancelPress()}
                  @pointerdown=${_=>this._onPointerDown(u,_)}
                  @pointerup=${_=>this._onPointerUp(u,_)}
                  @pointerleave=${()=>this._cancelPress()}
                >
                  <ha-icon icon=${f} style="color:${h?t.text:"var(--secondary-text-color)"}"></ha-icon>
                  <span class="row-label ${h?"":"row-label-off"}">${m}</span>
                  <span class="row-status" style="color:${h?t.text:"var(--secondary-text-color)"}">
                    ${g?l`${b}%`:h?"Acceso":"Spento"}
                  </span>
                </div>
                ${g?l`
                  <div class="slider-wrap">
                    <div class="slider-track" role="slider" tabindex="0"
                      aria-label=${`Luminosit\xE0 ${m}`} aria-valuemin="1" aria-valuemax="100" aria-valuenow=${b}
                      @keydown=${_=>this._onSliderKeyDown(u,_)}
                      @pointerdown=${_=>this._onSliderPointerDown(u,_)}>
    ...
    `}};x("pastel-lights-card-editor",le);window.customCards=window.customCards||[];window.customCards.push({type:"pastel-lights-card",name:"Pastel Lights Card",description:"Card per il controllo luci con stile pastello, conteggio SVG e slider luminosit\xE0.",preview:!0});var Tt={amber:{base:"#f59e0b",light:"#fde68a",bg:"#fef3c7",text:"#d97706"},blue:{base:"#3d9cf0",light:"#b8dafc",bg:"#e8f3fe",text:"#3d9cf0"},green:{base:"#34c472",light:"#bdeed4",bg:"#e6f9ef",text:"#1f9d5c"},pink:{base:"#ec4899",light:"#fbcfe8",bg:"#fce7f3",text:"#db2777"},purple:{base:"#9b5de5",light:"#ddd1f7",bg:"#f3ecff",text:"#8b3fd9"},red:{base:"#f05252",light:"#fac9c9",bg:"#fee8e8",text:"#e03c3c"},teal:{base:"#20c997",light:"#a8e8d3",bg:"#e6faf4",text:"#159b76"},orange:{base:"#f0943d",light:"#fcd9b0",bg:"#fef3e8",text:"#d9762a"},gray:{base:"#9ca3af",light:"#e5e7eb",bg:"#f3f4f6",text:"#6b7280"}},Vi=Object.keys(Tt);function Fi(r){return Tt[r]||Tt.blue}function Di(r,t){return t%2!==0&&r===t-1}var ce=class extends v{static get properties(){return{hass:{},config:{},_activating:{state:!0}}}static getStubConfig(){return{title:"",buttons:[{label:"Bottone",icon:"mdi:lightning-bolt",color:"blue",action:{type:"toggle",entity_id:""}}]}}setConfig(t){if(!t)throw new Error("Configurazione non valida");this.config={title:t.title||"",buttons:Array.isArray(t.buttons)?t.buttons:[]},this._activating={}}getCardSize(){return 1+Math.ceil((this.config.buttons||[]).length/2)}static getConfigElement(){return document.createElement("pastel-button-card-editor")}async _handleTap(t,e,i){if(i&&i.stopPropagation(),!t.action)return;try{window.hapticFeedback?window.hapticFeedback("light"):navigator.vibrate&&navigator.vibrate(30)}catch{}this._activating={...this._activating,[e]:!0},setTimeout(()=>{this._activating={...this._activating,[e]:!1}},200);let s=t.action;switch(s.type){case"toggle":s.entity_id&&this.hass.callService("homeassistant","toggle",{entity_id:s.entity_id});break;case"turn_on":if(s.entity_id){let[o]=s.entity_id.split(".");this.hass.callService(o,"turn_on",{entity_id:s.entity_id})}break;case"turn_off":if(s.entity_id){let[o]=s.entity_id.split(".");this.hass.callService(o,"turn_off",{entity_id:s.entity_id})}break;case"call_service":{let[o,a]=(s.service||"").split(".");o&&a&&this.hass.callService(o,a,s.data||{});break}case"scene":s.entity_id&&this.hass.callService("scene","turn_on",{entity_id:s.entity_id});break;case"script":s.entity_id&&this.hass.callService("script","turn_on",{entity_id:s.entity_id});break;case"navigate":s.navigation_path&&(history.pushState(null,"",s.navigation_path),window.dispatchEvent(new CustomEvent("location-changed",{bubbles:!0,composed:!0})));break;case"url":s.url_path&&window.open(s.url_path,s.new_tab!==!1?"_blank":"_self");break;case"more_info":if(s.entity_id){let o=new Event("hass-more-info",{bubbles:!0,composed:!0});o.detail={entityId:s.entity_id},this.dispatchEvent(o)}break;default:break}}render(){if(!this.config||!this.hass)return l``;let t=this.config.buttons||[],e=t.length;return l`
      <ha-card>
        ...
        <div class="button-grid">
          ${t.map((i,s)=>{let o=Fi(i.color),a=Di(s,e),n=this._activating&&this._activating[s];return l`
              <button
    ...
    `}};x("pastel-button-card",ce);var de=class extends v{static get properties(){return{hass:{},_config:{state:!0},_dragIndex:{state:!0},_dragOverIndex:{state:!0}}}setConfig(t){this._config={...t,buttons:[...t.buttons||[]]},this._dragIndex=null,this._dragOverIndex=null}_fireChanged(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_addButton(){let t=[...this._config.buttons||[],{label:"Nuovo bottone",icon:"mdi:lightning-bolt",color:"blue",action:{type:"toggle",entity_id:""}}];this._config={...this._config,buttons:t},this._fireChanged()}_removeButton(t){let e=[...this._config.buttons||[]];e.splice(t,1),this._config={...this._config,buttons:e},this._fireChanged()}_updateButton(t,e,i){let s=[...this._config.buttons||[]];s[t]={...s[t],[e]:i},this._config={...this._config,buttons:s},this._fireChanged()}_updateButtonAction(t,e,i){let s=[...this._config.buttons||[]];s[t]={...s[t],action:{...s[t].action||{},[e]:i}},this._config={...this._config,buttons:s},this._fireChanged()}_onDragStart(t,e){this._dragIndex=t,e.dataTransfer.effectAllowed="move",e.dataTransfer.setData("text/plain",String(t))}_onDragOver(t,e){e.preventDefault(),e.dataTransfer.dropEffect="move",this._dragOverIndex=t}_onDrop(t,e){if(e.preventDefault(),this._dragIndex===null||this._dragIndex===t){this._dragIndex=null,this._dragOverIndex=null;return}let i=[...this._config.buttons||[]],[s]=i.splice(this._dragIndex,1);i.splice(t,0,s),this._config={...this._config,buttons:i},this._dragIndex=null,this._dragOverIndex=null,this._fireChanged()}_onDragEnd(){this._dragIndex=null,this._dragOverIndex=null}_renderActionFields(t,e){let i=t.action?.type||"toggle",s=["toggle","turn_on","turn_off","more_info","scene","script"].includes(i),o=i==="call_service",a=i==="navigate",n=i==="url",c=i==="scene"?["scene"]:i==="script"?["script"]:void 0;return l`
      ...
      ${o?l`
        ...
        <ha-textfield
          ...
          @change=${d=>{try{let u=JSON.parse(d.target.value||"{}");this._updateButtonAction(e,"data",u)}catch{}}}
        ></ha-textfield>
      `:""}
    ...
    `}};x("pastel-button-card-editor",de);window.customCards=window.customCards||[];window.customCards.push({type:"pastel-button-card",name:"Pastel Button Card",description:"Griglia di bottoni pastello personalizzabili: colore, icona, etichetta e azione per ogni bottone. Layout automatico 2 colonne.",preview:!0});var At={amber:{base:"#f59e0b",light:"#fde68a",bg:"#fef3c7",text:"#d97706"},blue:{base:"#3d9cf0",light:"#b8dafc",bg:"#e8f3fe",text:"#3d9cf0"},green:{base:"#34c472",light:"#bdeed4",bg:"#e6f9ef",text:"#1f9d5c"},pink:{base:"#ec4899",light:"#fbcfe8",bg:"#fce7f3",text:"#db2777"},purple:{base:"#9b5de5",light:"#ddd1f7",bg:"#f3ecff",text:"#8b3fd9"},red:{base:"#f05252",light:"#fac9c9",bg:"#fee8e8",text:"#e03c3c"},teal:{base:"#20c997",light:"#a8e8d3",bg:"#e6faf4",text:"#159b76"},orange:{base:"#f0943d",light:"#fcd9b0",bg:"#fef3e8",text:"#d9762a"}},ai=Object.keys(At);function Hi(r){return At[r]||At.blue}var Ui=["auto","window","door","gate","garage","generic"],oi={window:{closed:"mdi:window-closed-variant",open:"mdi:window-open-variant"},door:{closed:"mdi:door-closed",open:"mdi:door-open"},gate:{closed:"mdi:gate",open:"mdi:gate-open"},garage:{closed:"mdi:garage",open:"mdi:garage-open"},generic:{closed:"mdi:square-outline",open:"mdi:square"}},qi={auto:"Automatico",window:"Finestra",door:"Porta",gate:"Cancello",garage:"Basculante",generic:"Generico"};function Yi(r,t){if(r&&r!=="auto")return r;if(!t)return"generic";let e=t.attributes?.device_class;return e==="window"?"window":e==="door"?"door":e==="gate"?"gate":e==="garage_door"?"garage":(t.entity_id?.startsWith("cover."),"generic")}function Wi(r){if(!r)return!1;let t=r.state;return t==="on"||t==="open"||t==="opening"||t==="true"}function Qi(r,t){let e=t?"1":"0",i=t?"rotate(-50)":"rotate(0)";return`
    ...
    </svg>`}function Gi(r,t){let e=t?"perspective(300px) rotateY(-55deg)":"perspective(300px) rotateY(0deg)",i=t?"1":"0";return`
    ...
    </svg>`}function Ki(r,t){let e=t?"perspective(300px) rotateY(-70deg)":"rotateY(0deg)",i=t?"perspective(300px) rotateY(70deg)":"rotateY(0deg)",s=t?"0":"1";return`
    ...
    </svg>`}function Xi(r,t){let e=t?"perspective(400px) rotateX(-85deg)":"rotateX(0deg)",i=t?"1":"0",s=t?"#34c472":r.base;return`
    ...
    </svg>`}function Zi(r,t){let e=t?r.base:r.light;return`
      ...
      ">
            ...
            <div class="hero-row">
              ...
              <div class="hero-count-block">
                ...
                ${this.config.show_badge?l`
                  <div class="hero-badge ${n?"badge-safe":"badge-alert"}">${g}</div>
                `:""}
              </div>
            </div>
          </div>
        ...
        ${this.config.show_list&&s.length>0?l`
          <div class="panel-list">
            ${s.map((m,f)=>l`
              ${f>0?l`<div class="divider"></div>`:""}
              <div
                class="list-row ${m.open?"row-open":""}"
                @pointerdown=${b=>this._onPointerDown(m,b)}
                @pointerup=${b=>this._onPointerUp(m,b)}
                @pointerleave=${()=>this._onPointerLeave(m)}
                @pointermove=${b=>this._onPointerMove(m,b)}
                @pointercancel=${()=>this._onPointerLeave(m)}
              >
                <ha-icon icon=${m.icon}
                  style="color:${m.open?"var(--c-text)":"var(--secondary-text-color)"}">
                </ha-icon>
                <span class="row-name ${m.open?"":"row-name-closed"}">${m.name}</span>
                <span class="row-status ${m.open?"status-open":""}">
                  ${m.open?"Aperto":"Chiuso"}
                </span>
              </div>
            `)}
          </div>
        ...
        <div class="color-row">
          ${ai.map(e=>l`
            <button class="swatch ${t.color===e?"selected":""}"
              style="background:${At[e].base}" title=${e}
    ...
    `}static get styles(){return y`
      ...
      .add-button:hover { border-color:var(--primary-color,#3d9cf0); color:var(--primary-color,#3d9cf0); }
    `}};x("pastel-openings-card-editor",he);window.customCards=window.customCards||[];window.customCards.push({type:"pastel-openings-card",name:"Pastel Openings Card",description:"Card universale per porte, finestre, cancelli, basculanti \u2014 illustrazioni animate, filtri, ordinamento, azioni complete. Parte della suite Pastel.",preview:!0});var Pt={amber:{base:"#f59e0b",light:"#fde68a",bg:"#fef3c7",text:"#d97706"},blue:{base:"#3d9cf0",light:"#b8dafc",bg:"#e8f3fe",text:"#3d9cf0"},green:{base:"#34c472",light:"#bdeed4",bg:"#e6f9ef",text:"#1f9d5c"},pink:{base:"#ec4899",light:"#fbcfe8",bg:"#fce7f3",text:"#db2777"},purple:{base:"#9b5de5",light:"#ddd1f7",bg:"#f3ecff",text:"#8b3fd9"},red:{base:"#f05252",light:"#fac9c9",bg:"#fee8e8",text:"#e03c3c"},teal:{base:"#20c997",light:"#a8e8d3",bg:"#e6faf4",text:"#159b76"},orange:{base:"#f0943d",light:"#fcd9b0",bg:"#fef3e8",text:"#d9762a"}},ni=Object.keys(Pt),W={base:"#dc2626",light:"#fecaca",bg:"rgba(220,38,38,0.08)",text:"#991b1b"};function rs(r){return Pt[r]||Pt.amber}function os(r,t,e=50){let i=t?W.light:r.light,s=t?W.base:r.base,o=t?"#fef2f2":"#fffdf5",a=t?W.text:r.text,n=Math.round(e*1.36);return`
    <svg width="${e}" height="${n}" viewBox="0 0 44 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <ha-card style="--c-base:${t.base}; --c-light:${t.light}; --c-bg:${t.bg}; --c-text:${t.text};">
        ...
        <div class="panel rows">
          ${this.config.entities.map((c,d)=>{let u=typeof c=="string"?c:c.entity,p=this.hass.states[u];if(!p)return l`<div class="row missing">Entità non trovata: ${u}</div>`;let h=p.state==="on",g=this._entityLabel(c),m=this._entityIcon(c,h);return l`
              <div
                class="row ${h?"alarm":""}"
                @click=${f=>this._showMoreInfo(u,f)}
              >
                <ha-icon icon=${m} style="color:${h?W.base:"var(--secondary-text-color)"}"></ha-icon>
                <span class="row-label ${h?"row-label-alarm":"row-label-off"}">${g}</span>
        ...
        <div class="panel rows">
          ${this.config.entities.map((c,d)=>{let u=typeof c=="string"?c:c.entity,p=this.hass.states[u];if(!p)return l`<div class="row missing">Entità non trovata: ${u}</div>`;let h=p.state==="on",g=this._entityLabel(c),m=this._entityIcon(c,h);return l`
              <div
                ...
                @click=${f=>this._showMoreInfo(u,f)}
              >
                <ha-icon icon=${m} style="color:${h?t.text:"var(--secondary-text-color)"}"></ha-icon>
                <span class="row-label ${h?"row-label-active":"row-label-off"}">${g}</span>
    ...
    `}static get styles(){return y`
      ...
      .row.missing { color: var(--error-color, red); font-size: 12px; padding: 10px 14px; }
      .divider { height: 0.5px; background: rgba(0,0,0,0.08); margin: 0 14px; }
    `}};x("pastel-motion-presence-card",ge);var me=class extends v{static get properties(){return{hass:{},_config:{state:!0}}}setConfig(t){this._config={...t}}_valueChanged(t,e){this._config={...this._config,[t]:e},this._fireChanged()}_fireChanged(){let t=new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0});this.dispatchEvent(t)}render(){if(!this._config||!this.hass)return l``;let t=[{name:"title",selector:{text:{}}},{name:"subtitle",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"entities",selector:{entity:{multiple:!0,domain:"binary_sensor"}}},{name:"show_progress_bar",selector:{boolean:{}}}],e={title:this._config.title||"",subtitle:this._config.subtitle||"",icon:this._config.icon||"mdi:motion-sensor",entities:this._config.entities||[],show_progress_bar:this._config.show_progress_bar!==!1};return l`
      <div class="editor">
        <ha-form
          .hass=${this.hass}
          .data=${e}
    ...
    `}_labelFor(t){return{title:"Titolo",subtitle:"Sottotitolo (es. nome zona/piano)",icon:"Icona",entities:"Sensori di movimento/presenza",show_progress_bar:"Mostra barra di progresso"}[t]||t}static get styles(){return y`
      ...
      .swatch.selected { border-color: var(--primary-text-color); box-shadow: 0 0 0 2px var(--card-background-color, #fff); }
      .hint { font-size: 12px; color: var(--secondary-text-color); margin-top: 10px; }
    `}};x("pastel-motion-presence-card-editor",me);window.customCards=window.customCards||[];window.customCards.push({type:"pastel-motion-presence-card",name:"Pastel Motion & Presence Card",description:"Card per sensori di movimento/presenza con stile pastello, conteggio attivi e popup dettagli al tap.",preview:!0});var Nt={amber:{base:"#f59e0b",light:"#fde68a",bg:"#fef3c7",text:"#d97706"},blue:{base:"#3d9cf0",light:"#b8dafc",bg:"#e8f3fe",text:"#3d9cf0"},green:{base:"#34c472",light:"#bdeed4",bg:"#e6f9ef",text:"#1f9d5c"},pink:{base:"#ec4899",light:"#fbcfe8",bg:"#fce7f3",text:"#db2777"},purple:{base:"#9b5de5",light:"#ddd1f7",bg:"#f3ecff",text:"#8b3fd9"},red:{base:"#f05252",light:"#fac9c9",bg:"#fee8e8",text:"#e03c3c"},teal:{base:"#20c997",light:"#a8e8d3",bg:"#e6faf4",text:"#159b76"},orange:{base:"#f0943d",light:"#fcd9b0",bg:"#fef3e8",text:"#d9762a"}},ci=Object.keys(Nt),Q={base:"#dc2626",light:"#fecaca",bg:"rgba(220,38,38,0.08)",text:"#991b1b"};function ls(r){return Nt[r]||Nt.amber}function cs(r,t,e=50){let i=t?Q.light:r.light,s=t?Q.base:r.base,o=t?"#fef2f2":"#ffffff",a=t?Q.text:r.text,n=Math.round(e*1.2);return`
    <svg width="${e}" height="${n}" viewBox="0 0 44 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <ha-card style="--c-base:${t.base}; --c-light:${t.light}; --c-bg:${t.bg}; --c-text:${t.text};">
        ...
        <div class="panel rows">
          ${this.config.entities.map((d,u)=>{let p=typeof d=="string"?d:d.entity,h=this.hass.states[p];if(!h)return l`<div class="row missing">Entità non trovata: ${p}</div>`;let g=h.state==="on",m=this._entityLabel(d),f=this._entityIcon(d,g);return l`
              <div
                class="row ${g?"alarm":""}"
                @click=${b=>this._showMoreInfo(p,b)}
              >
                <ha-icon icon=${f} style="color:${g?Q.base:"var(--secondary-text-color)"}"></ha-icon>
                <span class="row-label ${g?"row-label-alarm":"row-label-off"}">${m}</span>
                <span class="row-status ${g?"badge-alarm":""}" style="color:${g?Q.base:"var(--secondary-text-color)"}">
                  ${["unknown","unavailable"].includes(h.state)?"Non disponibile":g?"Perdita":"OK"}
                </span>
              </div>
              ${u<this.config.entities.length-1?l`<div class="divider"></div>`:""}
            `})}
        </div>
    ...
    `}_labelFor(t){return{title:"Titolo",subtitle:"Sottotitolo (es. nome zona/piano)",icon:"Icona",entities:"Sensori perdita acqua",show_progress_bar:"Mostra barra di progresso"}[t]||t}static get styles(){return y`
      ...
      .swatch.selected { border-color: var(--primary-text-color); box-shadow: 0 0 0 2px var(--card-background-color, #fff); }
      .hint { font-size: 12px; color: var(--secondary-text-color); margin-top: 10px; }
    `}};x("pastel-water-leak-card-editor",ve);window.customCards=window.customCards||[];window.customCards.push({type:"pastel-water-leak-card",name:"Pastel Water Leak Card",description:"Card per sensori di perdita acqua con stile pastello, conteggio perdite e popup dettagli al tap.",preview:!0});var It={amber:{base:"#f59e0b",light:"#fde68a",bg:"#fef3c7",text:"#d97706"},blue:{base:"#3d9cf0",light:"#b8dafc",bg:"#e8f3fe",text:"#3d9cf0"},green:{base:"#34c472",light:"#bdeed4",bg:"#e6f9ef",text:"#1f9d5c"},pink:{base:"#ec4899",light:"#fbcfe8",bg:"#fce7f3",text:"#db2777"},purple:{base:"#9b5de5",light:"#ddd1f7",bg:"#f3ecff",text:"#8b3fd9"},red:{base:"#f05252",light:"#fac9c9",bg:"#fee8e8",text:"#e03c3c"},teal:{base:"#20c997",light:"#a8e8d3",bg:"#e6faf4",text:"#159b76"},orange:{base:"#f0943d",light:"#fcd9b0",bg:"#fef3e8",text:"#d9762a"}},di=Object.keys(It),G={base:"#dc2626",light:"#fecaca",bg:"rgba(220,38,38,0.08)",text:"#991b1b"};function ds(r){return It[r]||It.amber}function ps(r,t,e=50){let i=t?G.light:r.light,s=t?G.base:r.base,o=t?"#fef2f2":"#fffdf5",a=t?G.text:r.text,n=Math.round(e*1);return`
        ...
        <div class="panel rows">
          ${this.config.entities.map((d,u)=>{let p=typeof d=="string"?d:d.entity,h=this.hass.states[p];if(!h)return l`<div class="row missing">Entità non trovata: ${p}</div>`;let g=h.state==="on",m=this._entityLabel(d),f=this._entityIcon(d,g);return l`
              <div
                ...
                @click=${b=>this._showMoreInfo(p,b)}
              >
                <ha-icon icon=${f} style="color:${g?G.base:"var(--secondary-text-color)"}"></ha-icon>
                <span class="row-label ${g?"row-label-alarm":"row-label-off"}">${m}</span>
                <span class="row-status ${g?"badge-alarm":""}" style="color:${g?G.base:"var(--secondary-text-color)"}">
                  ${["unknown","unavailable"].includes(h.state)?"Non disponibile":g?"Allarme":"OK"}
                </span>
              </div>
              ${u<this.config.entities.length-1?l`<div class="divider"></div>`:""}
            `})}
    ...
    `}static get styles(){return y`
      ...
      .row.missing { color: var(--error-color, red); font-size: 12px; padding: 10px 14px; }
      .divider { height: 0.5px; background: rgba(0,0,0,0.08); margin: 0 14px; }
    `}};x("pastel-smoke-co-card",xe);var _e=class extends v{static get properties(){return{hass:{},_config:{state:!0}}}setConfig(t){this._config={...t}}_valueChanged(t,e){this._config={...this._config,[t]:e},this._fireChanged()}_fireChanged(){let t=new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0});this.dispatchEvent(t)}render(){if(!this._config||!this.hass)return l``;let t=[{name:"title",selector:{text:{}}},{name:"subtitle",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"entities",selector:{entity:{multiple:!0,domain:"binary_sensor"}}},{name:"show_progress_bar",selector:{boolean:{}}}],e={title:this._config.title||"",subtitle:this._config.subtitle||"",icon:this._config.icon||"mdi:smoke-detector",entities:this._config.entities||[],show_progress_bar:this._config.show_progress_bar!==!1};return l`
      <div class="editor">
        <ha-form
          .hass=${this.hass}
          .data=${e}
    ...
    <line x1="19" y1="28" x2="26" y2="28" stroke="${i.light}" stroke-width="2" stroke-linecap="round"/>
  </svg>`}async function ms(r,t){try{let i=`history/period/${new Date(Date.now()-72e5).toISOString()}?filter_entity_id=${t}&minimal_response=true&no_attributes=true`,s=await r.callApi("GET",i);if(!s?.[0]||s[0].length<2)return null;let o=s[0],a=parseFloat(o[0].state),n=parseFloat(o[o.length-1].state);return isNaN(a)||isNaN(n)?null:n-a}catch{return null}}function bs(r){return r===null?"":Math.abs(r)<.1?"stabile":(r>0?"+":"")+r.toFixed(1)+"\xB0"}var ye=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._config=null,this._hass=null,this._trends={},this._lastFetch=0}static getConfigElement(){return document.createElement("pastel-temp-card-editor")}static getStubConfig(){return{title:"Piano Terra",subtitle:"Temperature ambiente",color:"blue",temp_min:15,temp_max:35,alert_temp:30,alert_hum:65,show_trend:!0,rooms:[{name:"Ingresso",icon:"mdi:door",temp_entity:"",hum_entity:""},{name:"Salotto",icon:"mdi:sofa",temp_entity:"",hum_entity:""}]}}setConfig(t){if(!Array.isArray(t.rooms))throw new Error("pastel-temp-card: 'rooms' deve essere una lista");this._config={title:t.title??"Temperatura",subtitle:t.subtitle??"Temperature ambiente",color:ui.includes(t.color)?t.color:"blue",temp_min:t.temp_min??15,temp_max:t.temp_max??35,alert_temp:t.alert_temp??30,alert_hum:t.alert_hum??65,show_trend:t.show_trend!==!1,rooms:t.rooms},this._render()}set hass(t){this._hass=t,this._render(),this._config?.show_trend&&this._maybeRefreshTrends()}getCardSize(){return 2+(this._config?.rooms?.length??0)*2}async _maybeRefreshTrends(){let t=Date.now();if(t-this._lastFetch<300*1e3)return;this._lastFetch=t;let e={};for(let i of this._config.rooms)i.temp_entity&&(e[i.temp_entity]=await ms(this._hass,i.temp_entity));this._trends=e,this._render()}_avgTemp(){if(!this._hass)return null;let t=this._config.rooms.map(e=>parseFloat(this._hass.states[e.temp_entity]?.state)).filter(e=>!isNaN(e));return t.length?t.reduce((e,i)=>e+i,0)/t.length:null}_avgHum(){if(!this._hass)return null;let t=this._config.rooms.filter(e=>e.hum_entity).map(e=>parseFloat(this._hass.states[e.hum_entity]?.state)).filter(e=>!isNaN(e));return t.length?t.reduce((e,i)=>e+i,0)/t.length:null}_render(){if(!this._config)return;let t=this._config,e=this._hass,i=Ot[t.color],s=this._avgTemp(),o=this._avgHum(),a=s!==null?hi(s,t.temp_min,t.temp_max):0,n="rgba(255,255,255,0.45)",c="rgba(255,255,255,0.60)",d="rgba(255,255,255,0.45)",u=t.rooms.map(p=>{let h=e?.states[p.temp_entity],g=p.hum_entity?e?.states[p.hum_entity]:null,m=h?parseFloat(h.state):null,f=g?parseFloat(g.state):null,b=m!==null&&!isNaN(m)?m.toFixed(1)+"\xB0":"--\xB0",_=f!==null&&!isNaN(f)?Math.round(f)+"%":"--%",w=m!==null?hi(m,t.temp_min,t.temp_max):0,$=p.icon||"mdi:thermometer",T=m!==null&&m>=t.alert_temp,k=f!==null&&f>=t.alert_hum,N=T?" !":"",Si=k?" \u2191":"",Ne=this._trends[p.temp_entity]??null,zi=t.show_trend&&Ne!==null?`<span class="room-trend">${bs(Ne)}</span>`:"";return`
        <div class="room-row">
          <div class="room-top">
      ...
      <div class="card">
        ...
        <div class="summary">
          ${gs(s??t.temp_min,t.temp_min,t.temp_max,i)}
          <div>
      ...
      </div>`}},we=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._config=null,this._hass=null}setConfig(t){this._config={...t},this._render()}set hass(t){this._hass=t,this.shadowRoot.querySelectorAll("ha-entity-picker").forEach(e=>e.hass=t)}_fire(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config}},bubbles:!0,composed:!0}))}_set(t,e){this._config={...this._config,[t]:e},this._fire()}_setRoom(t,e,i){let s=[...this._config.rooms||[]];s[t]={...s[t],[e]:i},this._config={...this._config,rooms:s},this._fire(),this._renderRooms()}_addRoom(){let t=[...this._config.rooms||[],{name:"",icon:"mdi:thermometer",temp_entity:"",hum_entity:""}];this._config={...this._config,rooms:t},this._fire(),this._renderRooms()}_removeRoom(t){let e=[...this._config.rooms||[]];e.splice(t,1),this._config={...this._config,rooms:e},this._fire(),this._renderRooms()}_renderRooms(){let t=this.shadowRoot.getElementById("rooms-container");if(!t)return;t.innerHTML="",(this._config.rooms||[]).forEach((i,s)=>{let o=document.createElement("div");o.className="room-editor";let a=document.createElement("div");a.className="room-row1";let n=document.createElement("div");n.className="room-num",n.textContent=s+1;let c=document.createElement("ha-textfield");c.label="Nome stanza",c.value=i.name||"",c.style.flex="1",c.addEventListener("change",g=>this._setRoom(s,"name",g.target.value));let d=document.createElement("ha-textfield");d.label="Icona (mdi:...)",d.value=i.icon||"mdi:thermometer",d.style.width="140px",d.addEventListener("change",g=>this._setRoom(s,"icon",g.target.value));let u=document.createElement("button");u.className="del-btn",u.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 4h-3.5l-1-1h-5l-1 1H5v2h14M6 19a2 2 0 002 2h8a2 2 0 002-2V7H6v12z"/></svg>',u.addEventListener("click",()=>this._removeRoom(s)),a.appendChild(n),a.appendChild(c),a.appendChild(d),a.appendChild(u);let p=document.createElement("ha-entity-picker");p.hass=this._hass,p.value=i.temp_entity||"",p.label="Sensore temperatura",p.includeDomains=["sensor"],p.allowCustomEntity=!0,p.addEventListener("value-changed",g=>this._setRoom(s,"temp_entity",g.detail.value));let h=document.createElement("ha-entity-picker");h.hass=this._hass,h.value=i.hum_entity||"",h.label="Sensore umidit\xE0 (opzionale)",h.includeDomains=["sensor"],h.allowCustomEntity=!0,h.addEventListener("value-changed",g=>this._setRoom(s,"hum_entity",g.detail.value)),o.appendChild(a),o.appendChild(p),o.appendChild(h),t.appendChild(o)});let e=document.createElement("button");e.className="add-btn",e.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg> Aggiungi stanza',e.addEventListener("click",()=>this._addRoom()),t.appendChild(e)}_render(){if(!this._config)return;let t=this._config;this.shadowRoot.innerHTML=`
      <style>
        ...
        <div class="swatches">
          ${ui.map(i=>`
            <button class="swatch ${t.color===i?"sel":""}"
              style="background:${Ot[i].base}"
              data-color="${i}" title="${Ot[i].name}"></button>`).join("")}
        </div>
    ...
    `}render(){if(!this._config||!this.hass)return l``;let t=this._config;return l`
      <div class="editor">
        ...
        <div class="color-row">
          ${vi.map(e=>l`
            <button class="swatch ${t.color===e?"selected":""}"
              style="background:${Bt[e].base}" title=${e}
              @click=${()=>this._set("color",e)}></button>
          `)}
        </div>
    ...
    `}};x("pastel-thermostat-card-editor",ze);window.customCards=window.customCards||[];window.customCards.push({type:"pastel-thermostat-card",name:"Pastel Thermostat Card",description:"Card termostato/clima completamente configurabile: sensori liberi, target con slider, modalit\xE0 personalizzabili, colore pastello.",preview:!0});var ws="1.0.0",Vt={blue:{bg:"#dbeafe",base:"#2563eb",light:"#bfdbfe",name:"Azzurro"},green:{bg:"#dcfce7",base:"#16a34a",light:"#bbf7d0",name:"Verde"},purple:{bg:"#ede9fe",base:"#7c3aed",light:"#ddd6fe",name:"Viola"},teal:{bg:"#ccfbf1",base:"#0d9488",light:"#99f6e4",name:"Verde acqua"},amber:{bg:"#fef3c7",base:"#d97706",light:"#fde68a",name:"Ambra"},pink:{bg:"#fce7f3",base:"#db2777",light:"#fbcfe8",name:"Rosa"},indigo:{bg:"#e0e7ff",base:"#4338ca",light:"#c7d2fe",name:"Indaco"},cyan:{bg:"#cffafe",base:"#0891b2",light:"#a5f3fc",name:"Ciano"},red:{bg:"#fee2e2",base:"#dc2626",light:"#fecaca",name:"Rosso"},orange:{bg:"#ffedd5",base:"#ea580c",light:"#fed7aa",name:"Arancio"}},wi=Object.keys(Vt),ft={green:{bg:"#e6f9ef",base:"#34c472",name:"Verde"},red:{bg:"#fde9e9",base:"#ef4444",name:"Rosso"},blue:{bg:"#e8f3fe",base:"#3d9cf0",name:"Azzurro"},orange:{bg:"#fef3e2",base:"#f0943d",name:"Arancio"},teal:{bg:"#e6faf4",base:"#20c997",name:"Acqua"},purple:{bg:"#f3eefe",base:"#9061f9",name:"Viola"},pink:{bg:"#fce7f3",base:"#db2777",name:"Rosa"},yellow:{bg:"#fef9c3",base:"#ca8a04",name:"Giallo"}},$s=Object.keys(ft),xi={"mdi:air-conditioner":"M21 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v2a2 2 0 00-2 2v5h2v1h2v-1h10v1h2v-1h2v-5a2 2 0 00-2-2zM5 7h14v2H5V7zM3 14v-3h18v3H3z","mdi:power":"M16.56 5.44L15.11 6.89C16.84 7.94 18 9.83 18 12c0 3.31-2.69 6-6 6s-6-2.69-6-6c0-2.17 1.16-4.06 2.88-5.12L7.44 5.44C5.36 6.88 4 9.28 4 12c0 4.42 3.58 8 8 8s8-3.58 8-8c0-2.72-1.36-5.12-3.44-6.56zM13 3h-2v10h2V3z","mdi:snowflake":"M20 11h-2.5l1.5-1.5-1.41-1.41L15 11h-2v-2l2.91-2.91L14.5 4.68 13 6.18V3h-2v3.18L9.5 4.68 8.09 6.09 11 9v2H9L6.41 8.59 5 10l1.5 1.5H4v2h2.5L5 15l1.41 1.41L9 13h2v2l-2.91 2.91 1.41 1.41L11 17.82V21h2v-3.18l1.5 1.51 1.41-1.42L13 15v-2h2l2.59 2.59L19 14.09 17.5 13H20v-2z","mdi:white-balance-sunny":"M12 7a5 5 0 100 10 5 5 0 000-10zM12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41","mdi:water":"M12 2C6 9 4 13 4 16a8 8 0 0016 0c0-3-2-7-8-14z","mdi:fan":"M12 12a2 2 0 100-4 2 2 0 000 4zM12 2c2 0 4 1.5 4 4 0 1.3-.7 2.4-1.7 3M12 2c-2 0-4 1.5-4 4 0 1.3.7 2.4 1.7 3M22 12c0 2-1.5 4-4 4-1.3 0-2.4-.7-3-1.7M22 12c0-2-1.5-4-4-4-1.3 0-2.4.7-3 1.7M12 22c-2 0-4-1.5-4-4 0-1.3.7-2.4 1.7-3M12 22c2 0 4-1.5 4-4 0-1.3-.7-2.4-1.7-3M2 12c0-2 1.5-4 4-4 1.3 0 2.4.7 3 1.7M2 12c0 2 1.5 4 4 4 1.3 0 2.4-.7 3-1.7","mdi:weather-night":"M17.75 4.09l-2.53 1.94.91 3.06-2.63-1.81-2.63 1.81.91-3.06-2.53-1.94 3.17-.09L12 1l1.38 3-3.17.09zM21.25 11l-1.46.44-.44 1.46-.44-1.46L17.45 11l1.46-.44.44-1.46.44 1.46zM4.5 6.375l-1.1.33-.33 1.1-.33-1.1-1.09-.33 1.09-.33.33-1.1.33 1.1zM21 21l-9-9c0 0-3-2-5 0c-2 2 0 5 3 8z","mdi:thermostat":"M15 13V5a3 3 0 00-6 0v8a5 5 0 106 0zm-3 5a3 3 0 110-6 3 3 0 010 6z"};function ks(r){return xi[r]||xi["mdi:air-conditioner"]}function ut(r,t,e=16){return`<svg width="${e}" height="${e}" viewBox="0 0 24 24" fill="${t}"><path d="${ks(r)}"/></svg>`}function _i(r,t,e){if(!t||!r)return null;let i=r.states[t];if(!i)return null;let s=t.split(".")[0];if(["switch","input_boolean","binary_sensor"].includes(s))return i.state==="on";let o=parseFloat(i.state);return isNaN(o)?i.state==="on":o>=(e??5)}function yi(r,t){if(!t||!r)return!1;let e=t.split(".")[0];if(["switch","input_boolean","binary_sensor"].includes(e))return!1;let i=r.states[t];return i?!isNaN(parseFloat(i.state)):e==="sensor"}function Es(r,t,e){return Math.min(e,Math.max(t,r))}var Ce=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._config=null,this._hass=null}static getConfigElement(){return document.createElement("pastel-clima-card-editor")}static getStubConfig(){return{title:"Climatizzatore",subtitle:"Raffreddamento",color:"blue",temp_entity:"",hum_entity:"",power_entity:"",power_threshold:5,show_fan:!1,fan_entity:"",buttons:[{name:"Accendi",icon:"mdi:power",color:"green",action:{action:"none"}},{name:"Spegni",icon:"mdi:power",color:"red",action:{action:"none"}},{name:"Clima",icon:"mdi:snowflake",color:"blue",action:{action:"none"}},{name:"Caldo",icon:"mdi:white-balance-sunny",color:"orange",action:{action:"none"}},{name:"Deumidifica",icon:"mdi:water",color:"teal",action:{action:"none"}},{name:"Ventola",icon:"mdi:fan",color:"purple",action:{action:"none"}}]}}setConfig(t){if(!Array.isArray(t.buttons))throw new Error("pastel-clima-card: 'buttons' deve essere una lista");this._config={title:t.title??"Climatizzatore",subtitle:t.subtitle??"",color:wi.includes(t.color)?t.color:"blue",temp_entity:t.temp_entity??"",hum_entity:t.hum_entity??"",power_entity:t.power_entity??"",power_threshold:t.power_threshold??5,show_fan:t.show_fan??!1,fan_entity:t.fan_entity??"",fan_label:t.fan_label??"Velocit\xE0 ventola",image_url:t.image_url??new URL("./ac-unit.svg",import.meta.url).href,buttons:t.buttons},this._render()}set hass(t){this._hass=t,this._render()}getCardSize(){return 3+Math.ceil((this._config?.buttons?.length??0)/2)+(this._config?.show_fan?1:0)}_callButtonAction(t){if(!this._hass||!t?.action)return;let e=t.action;if(!(!e.action||e.action==="none"))if(e.action==="call-service"||e.action==="perform-action"){let i=e.service||e.perform_action;if(!i)return;let[s,o]=i.split(".");this._hass.callService(s,o,e.service_data||e.data||{},e.target||{})}else if(e.action==="toggle"&&e.entity){let i=e.entity.split(".")[0];this._hass.callService(i,"toggle",{},{entity_id:e.entity})}else e.action==="navigate"&&e.navigation_path&&(history.pushState(null,"",e.navigation_path),window.dispatchEvent(new CustomEvent("location-changed")))}_render(){if(!this._config)return;let t=this._config,e=this._hass,i=Vt[t.color],s=t.temp_entity?parseFloat(e?.states[t.temp_entity]?.state):null,o=t.hum_entity?parseFloat(e?.states[t.hum_entity]?.state):null,a=s!==null&&!isNaN(s)?s.toFixed(1):"--",n=o!==null&&!isNaN(o)?Math.round(o)+"%":null,c=t.power_entity?_i(e,t.power_entity,t.power_threshold):null,d="rgba(255,255,255,0.45)",p=c!==null?`
      <div class="status-badge" style="background:rgba(255,255,255,0.65);color:${i.base}">
        ...
        ${c?"Acceso":"Spento"}
      </div>`:"",h=t.buttons.map((m,f)=>{let b=ft[m.color]||ft.blue,_=null;m.state_entity&&(_=_i(e,m.state_entity,m.state_threshold));let w=_?`box-shadow:0 0 0 2px ${b.base} inset;`:"";return`
        <button class="pbtn" data-idx="${f}" style="background:${b.bg};color:${b.base};${w}">
          ${ut(m.icon||"mdi:air-conditioner",b.base,22)}
          <span>${m.name||""}</span>
        </button>`}).join(""),g="";if(t.show_fan&&t.fan_entity){let m=e?.states[t.fan_entity],f=0,b="--";if(m){let _=t.fan_entity.split(".")[0];if(_==="input_number"||_==="number"){let w=parseFloat(m.attributes?.min??0),$=parseFloat(m.attributes?.max??100),T=parseFloat(m.state);f=Es((T-w)/($-w)*100,0,100),b=m.state}else if(_==="select"||_==="input_select"){b=m.state;let w=m.attributes?.options||[],$=w.indexOf(m.state);f=w.length>1?$/(w.length-1)*100:0}else b=m.state}g=`
        <div class="fan-row" style="background:${d}">
          <div class="fan-top">
            <div class="fan-label" style="color:${i.base}">
              ${ut("mdi:fan",i.base,16)}
              ${t.fan_label}
            </div>
            <div class="fan-value" style="color:${i.base}">${b}</div>
          </div>
          <div class="fan-track" style="background:${i.light}">
            <div class="fan-fill" style="width:${f}%;background:${i.base}"></div>
            <div class="fan-thumb" style="left:calc(${f}% - 10px)"></div>
          </div>
      ...
      <div class="card">
        <div class="header">
          <div class="header-icon">
            ${ut("mdi:air-conditioner",i.base,24)}
          </div>
          <div>
        ...
        ${g}
      </div>`,this.shadowRoot.querySelectorAll(".pbtn").forEach(m=>{m.addEventListener("click",()=>{let f=parseInt(m.dataset.idx,10);this._callButtonAction(t.buttons[f])})})}},Me=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._config=null,this._hass=null}setConfig(t){this._config={...t},this._render()}set hass(t){this._hass=t,this.shadowRoot.querySelectorAll("ha-entity-picker").forEach(e=>e.hass=t),this.shadowRoot.querySelectorAll("ha-icon-picker").forEach(e=>e.hass=t),this.shadowRoot.querySelectorAll("ha-selector").forEach(e=>e.hass=t)}_fire(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{...this._config}},bubbles:!0,composed:!0}))}_set(t,e){this._config={...this._config,[t]:e},this._fire()}_setBtn(t,e,i){let s=[...this._config.buttons||[]];s[t]={...s[t],[e]:i},this._config={...this._config,buttons:s},this._fire()}_addBtn(){let t=[...this._config.buttons||[],{name:"Nuovo tasto",icon:"mdi:air-conditioner",color:"blue",action:{action:"none"},state_entity:"",state_threshold:5}];this._config={...this._config,buttons:t},this._fire(),this._renderButtons()}_removeBtn(t){let e=[...this._config.buttons||[]];e.splice(t,1),this._config={...this._config,buttons:e},this._fire(),this._renderButtons()}_moveBtn(t,e){let i=[...this._config.buttons||[]],s=t+e;s<0||s>=i.length||([i[t],i[s]]=[i[s],i[t]],this._config={...this._config,buttons:i},this._fire(),this._renderButtons())}_renderButtons(){let t=this.shadowRoot.getElementById("buttons-container");if(!t)return;t.innerHTML="";let e=(this._config.buttons||[]).length;(this._config.buttons||[]).forEach((s,o)=>{let a=document.createElement("div");a.className="btn-editor";let n=document.createElement("div");n.className="btn-row1";let c=document.createElement("div");c.className="order-wrap";let d=document.createElement("button");d.className="order-btn",d.disabled=o===0,d.title="Sposta su",d.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7 14l5-5 5 5z"/></svg>',d.addEventListener("click",()=>this._moveBtn(o,-1));let u=document.createElement("button");u.className="order-btn",u.disabled=o===e-1,u.title="Sposta gi\xF9",u.innerHTML='<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7 10l5 5 5-5z"/></svg>',u.addEventListener("click",()=>this._moveBtn(o,1)),c.appendChild(d),c.appendChild(u);let p=document.createElement("div");p.className="btn-num",p.textContent=o+1;let h=document.createElement("ha-textfield");h.label="Nome tasto",h.value=s.name||"",h.style.flex="1",h.addEventListener("change",k=>this._setBtn(o,"name",k.target.value));let g=document.createElement("button");g.className="del-btn",g.title="Rimuovi tasto",g.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 4h-3.5l-1-1h-5l-1 1H5v2h14M6 19a2 2 0 002 2h8a2 2 0 002-2V7H6v12z"/></svg>',g.addEventListener("click",()=>this._removeBtn(o)),n.appendChild(c),n.appendChild(p),n.appendChild(h),n.appendChild(g);let m=document.createElement("div");m.className="btn-row2";let f=document.createElement("ha-icon-picker");f.hass=this._hass,f.label="Icona",f.value=s.icon||"mdi:air-conditioner",f.style.flex="1",f.addEventListener("value-changed",k=>this._setBtn(o,"icon",k.detail.value)),m.appendChild(f);let b=document.createElement("div");b.className="color-swatches",$s.forEach(k=>{let N=document.createElement("button");N.className="mini-swatch"+(s.color===k?" sel":""),N.style.background=ft[k].base,N.title=ft[k].name,N.addEventListener("click",()=>{this._setBtn(o,"color",k),this._renderButtons()}),b.appendChild(N)});let _=document.createElement("div");_.className="mini-label",_.textContent="Azione al tocco";let w=document.createElement("ha-selector");w.hass=this._hass,w.selector={action:{}},w.value=s.action||{action:"none"},w.addEventListener("value-changed",k=>this._setBtn(o,"action",k.detail.value));let $=document.createElement("div");$.className="mini-label",$.textContent="Entit\xE0 stato attivo (opzionale)";let T=document.createElement("ha-entity-picker");if(T.hass=this._hass,T.label="Entit\xE0 (boolean o sensore)",T.value=s.state_entity||"",T.allowCustomEntity=!0,T.addEventListener("value-changed",k=>{this._setBtn(o,"state_entity",k.detail.value),this._renderButtons()}),a.appendChild(n),a.appendChild(m),a.appendChild(b),a.appendChild(_),a.appendChild(w),a.appendChild($),a.appendChild(T),s.state_entity&&yi(this._hass,s.state_entity)){let k=document.createElement("ha-textfield");k.label="Soglia attivo (es. Watt)",k.type="number",k.value=s.state_threshold??5,k.addEventListener("change",N=>this._setBtn(o,"state_threshold",parseFloat(N.target.value))),a.appendChild(k)}t.appendChild(a)});let i=document.createElement("button");i.className="add-btn",i.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg> Aggiungi tasto',i.addEventListener("click",()=>this._addBtn()),t.appendChild(i)}_render(){if(!this._config)return;let t=this._config,e=t.power_entity&&yi(this._hass,t.power_entity);this.shadowRoot.innerHTML=`
      <style>
        .editor { display:flex; flex-direction:column; gap:12px; padding:4px 0; }
        .section-title {
        ...
        <div class="swatches">
          ${wi.map(o=>`
            <button class="swatch ${t.color===o?"sel":""}"
              style="background:${Vt[o].base}"
              data-color="${o}" title="${Vt[o].name}"></button>`).join("")}
        </div>
    ...
    `}};x("pastel-dishwasher-card-editor",Ae);window.customCards=window.customCards||[];window.customCards.push({type:"pastel-dishwasher-card",name:"Pastel Dishwasher Card",description:"Card lavastoviglie con illustrazione animata, rilevamento stato da consumo o booleano, colore personalizzabile.",preview:!0});var Ei={amber:{base:"#f59e0b",bg:"#fef3c7"},blue:{base:"#3b82f6",bg:"#dbeafe"},green:{base:"#10b981",bg:"#d1fae5"},pink:{base:"#ec4899",bg:"#fce7f3"},purple:{base:"#a855f7",bg:"#f3e8ff"},red:{base:"#ef4444",bg:"#fee2e2"},teal:{base:"#14b8a6",bg:"#ccfbf1"},orange:{base:"#f97316",bg:"#ffedd5"}},Cs={mowing:"In funzione",docked:"Alla base",paused:"In pausa",returning:"Ritorno alla base",error:"Errore",unavailable:"Non disponibile",unknown:"Sconosciuto"};function et(r){return r?["unknown","unavailable","",null,void 0].includes(r.state):!0}var Pe=class extends v{static get properties(){return{hass:{},config:{}}}setConfig(t){if(!t.mower_entity)throw new Error("Devi specificare mower_entity");this.config={title:"Robot tagliaerba",subtitle:"Robot tagliaerba",icon:"mdi:robot-mower",color:"green",image_url:new URL("./lawn-mower.png",import.meta.url).href,...t}}getCardSize(){return 4}_fire(t){let e=new Event("hass-more-info",{bubbles:!0,composed:!0});e.detail={entityId:t},this.dispatchEvent(e)}_callService(t,e){!this.hass||!this.config.mower_entity||this.hass.callService(t,e,{entity_id:this.config.mower_entity})}render(){if(!this.hass||!this.config)return l``;let t=this.hass.states[this.config.mower_entity],e=t?t.state:"unavailable",i=et(t),s=Ei[this.config.color]||Ei.green,o=Cs[e]||e,a=this.config.battery_entity?this.hass.states[this.config.battery_entity]:null,n=this.config.area_entity?this.hass.states[this.config.area_entity]:null,c=this.config.time_remaining_entity?this.hass.states[this.config.time_remaining_entity]:null,d=this.config.blade_entity?this.hass.states[this.config.blade_entity]:null,u=this.config.zone_entity?this.hass.states[this.config.zone_entity]:null,p=a&&!et(a)?a.state:null,h=n&&!et(n)?n.state:null,g=c&&!et(c)?`${Math.floor(c.state/60)}:${String(c.state%60).padStart(2,"0")}`:null,m=d&&!et(d)?d.state:null,f=u&&!et(u)?u.state:null,b=f&&e==="mowing",_=!i&&e!=="mowing",w=!i&&e==="mowing",$=!i&&e!=="docked"&&e!=="returning";return l`
      <ha-card style="--c-base:${s.base}; --c-bg:${s.bg};">
        <div class="header" @click=${()=>this._fire(this.config.mower_entity)}>
          <img class="icon-img" src="${this.config.image_url}" @error=${T=>{T.target.style.display="none"}} />
          <div class="titles">
            <div class="title">${this.config.title}</div>
            <div class="subtitle">${this.config.subtitle}</div>
          </div>
        ...
        ${b?l`<div class="zone-chip" @click=${()=>this._fire(this.config.zone_entity)}>
              <ha-icon icon="mdi:map-marker"></ha-icon> Zona: ${f}
            </div>`:""}
        ...
        <div class="stats">
          ...
          ${g!==null?l`<div class="stat" @click=${()=>this._fire(this.config.time_remaining_entity)}>
                <div class="stat-label">Tempo</div>
                <div class="stat-value">${g}</div>
              </div>`:""}
          ${m!==null?l`<div class="stat" @click=${()=>this._fire(this.config.blade_entity)}>
    ...
    `}static getConfigElement(){return document.createElement("pastel-lawn-mower-card-editor")}static getStubConfig(){return{mower_entity:""}}},Le=class extends v{static get properties(){return{hass:{},_config:{}}}setConfig(t){this._config=t}_valueChanged(t){let e=t.target,i=e.configValue;if(!i)return;let s=t.detail&&t.detail.value!==void 0?t.detail.value:e.value;this._config={...this._config,[i]:s};let o=new CustomEvent("config-changed",{detail:{config:this._config}});this.dispatchEvent(o)}_entityPicker(t,e,i=!1){return l`
      <ha-entity-picker
        .hass=${this.hass}
    ...
    `}};x("pastel-lawn-mower-card",Pe);x("pastel-lawn-mower-card-editor",Le);window.customCards=window.customCards||[];window.customCards.push({type:"pastel-lawn-mower-card",name:"Pastel Lawn Mower Card",description:"Card pastello per robot tagliaerba con controlli, stato lame e zona corrente."});for(let[r,t]of Object.entries({"pastel-appliance-card":dt,"pastel-appliance-card-editor":ht,"pastel-robot-card":Et,"pastel-robot-card-editor":pt,"pastel-climate-card":zt,"pastel-climate-card-editor":Ct}))customElements.get(r)?console.warn(`Pastel UI: ${r} gi\xE0 caricato; rimuovi la vecchia risorsa.`):customElements.define(r,t);window.customCards=window.customCards||[];for(let[r,t,e]of[["pastel-appliance-card","Pastel Appliance","Elettrodomestici, aria e acqua. Associa i controlli del tuo dispositivo."],["pastel-robot-card","Pastel Robot","Pulizia e giardino, con mappa e zone quando disponibili."],["pastel-climate-card","Pastel Climate","Temperatura e modalit\xE0 supportate dal climatizzatore."]])window.customCards.some(i=>i.type===r)||window.customCards.push({type:r,name:t,description:e,preview:!0});console.info("Pastel UI 0.1.0-beta.1");window.customCards=window.customCards.filter((r,t,e)=>e.findIndex(i=>i.type===r.type)===t);
